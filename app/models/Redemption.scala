...
case class RedemptionFund(fundId: Long, fundName: String, plan: String, option: FundOption, folioNo: String, holdingMode: String, selectedRedemptionMode: Option[String] = None,
                          amount: Double, amountUnitFlag: Boolean, fullPartialFlag: Boolean, totalUnits: Option[BigDecimal] = None, redeemableUnits: Option[BigDecimal] = None,
                          currValue: Option[Double] = None, currNav: Option[Double] = None, navDate: Option[Date] = None, redemptionAllowed: Option[String],
                          minQuantity: Option[Double], minAmount: Option[Double], quantityMultiple: Option[Double], amountMultiple: Option[Double])
