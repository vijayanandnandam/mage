...
case class Bank(bankName: Option[String], IFSC: Option[String], city: Option[String], state: Option[String], branch: Option[String], district: Option[String],
                MICR: Option[String], address: Option[String], bankType: Option[String] = None, bmtrfnum:Option[Long] = None)
