...
case class Checkout(checkoutId: String,
                    ...
                    bseBankDetails:Option[JsValue] = None)
...
case class CheckoutBank(id: Option[Long] = None,
                        ...
                        bankType: Option[String] = None,
                        bmtrfnum:Option[Long] = None)
...
case class SummaryFund(soptRfnum: Long,
                       ...
                       amount: Long,
                       freshAdditionalType: Option[String] = None,
                       folioNo:Option[String] = None,
...
case class CheckoutLZeroLOne(summaryFund:SummaryFund, isLOne:Boolean = false,
                             isLZero:Boolean = false, lOneLZeroDetails: Option[LOneLZeroDetails] = None)
...
object CheckoutJsonFormats {
  ...
  implicit val checkoutLZeroLOneFormat = Json.format[CheckoutLZeroLOne]
}