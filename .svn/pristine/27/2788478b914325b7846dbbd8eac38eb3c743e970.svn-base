...
import data.model.Tables.{Fcaipt, FcaiptRow, Fcamct, FcamctRow, FcbseRow, Fcctmt, FcctmtRow, Fcdam, Fcdrd, FcdrdRow, Fcdsa, Fcdsd, FcdsdRow, FcostmRow, Fcramt, FcramtRow, Fcremt, Fcsft, Fcsmt, FcsmtRow, FcsoelRow, Fcsopt, FcsoptRow, Fcsra, Fcsraa}
...
class SchemeRepository @Inject()(protected val dbConfigProvider: DatabaseConfigProvider, fcsmtRepo: FcsmtRepo,
                                 ...
                                 fcbseRepo: FcbseRepo, fcsoelRepo: FcsoelRepo)
  ...
  def getSchemePrice(soptrfnum: Long, date: Date): Future[Option[BigDecimal]] = {
    ...
    val query = sql"""SELECT
                ...
                FROM
                    FCDSA
                WHERE
                    DSADAMRFNUM = ${MSTAR_DATASOURCE_ID} AND DSASOPTRFNUM = ${soptrfnum})
