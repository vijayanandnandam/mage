...
INSERT INTO `FCACT` (`ACTRFNUM`, `ACTCONSTANTNAME`, `ACTCONSTANTVALUE`, `ACTACTIVE`,`CREATEDATE`, `MODIFYDATE`, `CREATEDBY`, `LASTMODIFIEDBY`) VALUES (13, 'SERVER_USER', 'server:fincash', 'Y',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP, 'admin', 'admin');
...
ALTER TABLE `FCSIP`
  CHANGE COLUMN `SIPBSEREF` `SIPBSEREF` CHAR(16) NULL ,
  CHANGE COLUMN `SIPMMTLRFNUM` `SIPMMTLRFNUM` BIGINT(20) NULL ;
ALTER TABLE `FCSST`
  CHANGE COLUMN `SSTBSETRXNREF` `SSTBSETRXNREF` CHAR(16) NULL ;

ALTER TABLE `FCSDT`
  DROP COLUMN `SDTDATE`,
  CHANGE COLUMN `SDTFROMTIME` `SDTFROMTIME` TIMESTAMP NOT NULL DEFAULT '2017-01-01 00:00:01' ,
  CHANGE COLUMN `SDTTOTIME` `SDTTOTIME` TIMESTAMP NOT NULL DEFAULT '2017-01-01 00:00:01' ;