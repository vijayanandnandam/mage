...
INSERT INTO `FCLPSA` (`LPSAPSTRFNUM`, `LPSASMTRFNUM`, `LPSASEQUENCENO`, `LPSAINVESTMENTMODE`, `LPSASOPTRFNUM`, `CREATEDBY`, `LASTMODIFIEDBY`) VALUES ('3', '1198', '2', 'L', '106485', 'admin', 'admin');
