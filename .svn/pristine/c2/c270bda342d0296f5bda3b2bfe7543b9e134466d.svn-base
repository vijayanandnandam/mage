...
/**
  ...
  */
@Singleton
class BSERequestLogRepository @Inject()(integrationRepository: IntegrationRepository) extends IntegrationConstants {
  ...
  private def saveRequestLog(paramListTuple: (ListBuffer[String], ListBuffer[String]), integrationId: String, userName: String) = {
    ...
    integrationRepository.saveRequestParameters(BSE_INTEGRATION_NAME, Some(integrationId), paramNameList, paramValueList, userName)
  }
