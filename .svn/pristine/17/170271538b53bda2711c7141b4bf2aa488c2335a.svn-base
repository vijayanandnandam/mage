...
trait IntegrationConstants extends DBConstants{

  final val BSE_ORDER_API_PASS_CODE = "BSE_ORDER_API"

  final val BSE_UPLOAD_API_PASS_CODE = "BSE_UPLOAD_API"

  final val BSE_INTEGRATION_VALUE = 1L

  final val RELIANCE_INTEGRATION_VALUE = 2L

  final val BIRLA_INTEGRATION_VALUE = 3L
  ...
  final val BSE_EUIN_KEY = "BSE_EUIN"

  final val BSE_BANK_DETAIL_KEY = "BSE_BANK_DETAILS"

  /**
    * RELIANCE Integration Name
    */
  final val RELIANCE_INTEGRATION_NAME = "RELIANCE"
  final val REL_APIKEY_KEY = "apikey"
  final val REL_DEVICE_ID_KEY = "deviceid"
  final val REL_APP_VERSION_KEY = "appVersion"
  final val REL_APP_NAME_KEY = "appName"
  final val REL_USER_ID_KEY = "userid"
  final val REL_FUND_KEY = "fund"
  final val REL_ACNO_KEY = "acno"
  final val REL_ARN_CODE_KEY = "arncode"
  final val REL_SCHEME_KEY = "scheme"
  final val REL_PLAN_KEY = "plan"
  final val REL_OPTIONS_KEY = "options"
  final val REL_REDFLAG_KEY = "RedFlag"
  final val REL_UNITAMTFLAG_KEY = "UnitamtFlag"
  final val REL_UNITAMTVALUE_KEY = "UnitAmtValue"
  final val REL_TPIN_KEY = "Tpin"
  final val REL_MSTATUS_KEY = "Mstatus"
  final val REL_IP_KEY = "ip"
  final val REL_OLDIHNO_KEY = "oldihno"
  final val REL_TRDATE_KEY = "trdate"
  final val REL_ENTRYDATE_KEY = "entdate"
  final val REL_BRANCH_KEY = "branch"

  /**
    * BIRLA Integration Name
    */
    final val BSL_INTEGRATION_NAME = "BSL"

  //Mode of Holding
  final val BSE_SINGLE: String = "SI";
  final val BSE_JOINT: String = JOINT;
  final val BSE_ANYONE_OR_SURVIVOR = ANYONE_OR_SURVIVOR;
