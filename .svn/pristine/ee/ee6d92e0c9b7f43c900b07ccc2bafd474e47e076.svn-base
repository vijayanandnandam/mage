...
case class SubOrderAdditionalDetails(instantFlag: Boolean = true, prodSolnId: Option[Long] = None, prodSolnName: Option[String] = None, isLOne: Option[Boolean] = None,
                                     isLZero: Option[Boolean] = None, lOneLZeroDetails: Option[LOneLZeroDetails] = None)

case class LOneLZeroDetails(orderCutOffTime: String, fundsCutOffTime: String)
...
case class ProcessedSubOrderModel(subOrderId: Long, orderProcessed: Long, soptrfnum: Long, investmentMode: String, orderType: String, buySellType: String,
                                  ...
                                  sipFrequency: Option[String] = None, sipDayOfMonth: Option[Int] = None, quantity: Option[Double] = None, stateNo: Option[Long] = None)

case class ProcessedOrderModel(orderId: Long, subOrderList: List[ProcessedSubOrderModel], orderTime: Option[String] = None,
                               paymentRedirect: Option[Boolean] = None, userId: Option[Long] = None, userName: Option[String] = None)
...
case class SubOrderDetails(subOrderId: Long, orderProcessed: Long, investmentMode: String, createDate: String, buySellType: String, schemeName: Option[String] = None,
                           ...
                           stateDetails: Option[OrderStateDetails] = None, ackAdditionalDetails: Option[SubOrderAckAdditionalDetails] = None)

case class OrderStateDetails(stateCode: String, stateRfnum: Long)

case class SubOrderAckAdditionalDetails(channel: String)
...
case class NeftRtgsBankDetails(heading: String, bankId: Long, subHeading: String, beneficiaryName: String, accountNo: String, fullAccountNo: String, ifsc: String)

object OrderJsonFormats {

  implicit val neftRtgsBankDetailsJsonFormat = Json.format[NeftRtgsBankDetails]
  implicit val lOneDetailsJsonFormat = Json.format[LOneLZeroDetails]
  implicit val subOrderAckAdditionalDetailsJsonFormat = Json.format[SubOrderAckAdditionalDetails]
