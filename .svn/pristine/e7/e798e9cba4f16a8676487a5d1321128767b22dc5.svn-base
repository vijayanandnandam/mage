...
trait Tables {
  ...
  lazy val schema = Array(Fcact.schema, Fcaipt.schema, Fcall.schema, Fcalt.schema, Fcamct.schema, Fcamt.schema, Fcanst.schema, Fcara.schema, Fcasbt.schema, Fcasst.schema, Fcbbt.schema, Fcbca.schema, Fcbcra.schema, Fcbda.schema, Fcben.schema, Fcbmt.schema, Fcbpa.schema, Fcbra.schema, Fcbraa.schema, Fcbrta.schema, Fcbsat.schema, Fcbse.schema, Fcbsuf.schema, Fcbua.schema, Fccnd.schema, Fccomt.schema, Fccost.schema, Fccrt.schema, Fccst.schema, Fcctmt.schema, Fccyr.schema, Fcdam.schema, Fcdbd.schema, Fcdbr.schema, Fcdmt.schema, Fcdpc.schema, Fcdrd.schema, Fcdrqp.schema, Fcdsa.schema, Fcdsd.schema, Fcebse.schema, Fcefut.schema, Fceubd.schema, Fcfhs.schema, Fcfht.schema, Fcfome.schema, Fcfomt.schema, Fcfpt.schema, Fcfrl.schema, Fcfrt.schema, Fcfut.schema, Fcholi.schema, Fchspa.schema, Fcimt.schema, Fcipv.schema, Fcirql.schema, Fcirsl.schema, Fckcl.schema, Fckra.schema, Fckyc.schema, Fclpsa.schema, Fcmdt.schema, Fcmer.schema, Fcmmt.schema, Fcmmtl.schema, Fcndt.schema, Fcoaf.schema, Fcoht.schema, Fcolt.schema, Fcomt.schema, Fcooa.schema, Fcopd.schema, Fcosht.schema, Fcostm.schema, Fcotpt.schema, Fcpass.schema, Fcppa.schema, Fcprmt.schema, Fcpst.schema, Fcqkey.schema, Fcqmt.schema, Fcqst.schema, Fcrag.schema, Fcramt.schema, Fcrbt.schema, Fcrdl.schema, Fcremt.schema, Fcrfl.schema, Fcrlt.schema, Fcrmt.schema, Fcrpa.schema, Fcrta.schema, Fcsaa.schema, Fcscq.schema, Fcscra.schema, Fcsdt.schema, Fcsec.schema, Fcset.schema, Fcsft.schema, Fcsia.schema, Fcsidt.schema, Fcsip.schema, Fcsiph.schema, Fcsips.schema, Fcsit.schema, Fcslmt.schema, Fcsmt.schema, Fcsoct.schema, Fcsoel.schema, Fcsoit.schema, Fcsopt.schema, Fcsot.schema, Fcspsm.schema, Fcspst.schema, Fcsra.schema, Fcsraa.schema, Fcssh.schema, Fcsst.schema, Fcstt.schema, Fcsttl.schema, Fctkt.schema, Fctkth.schema, Fctlt.schema, Fcuaa.schema, Fcuact.schema, Fcubd.schema, Fcuft.schema, Fcull.schema, Fcult.schema, Fcuoa.schema, Fcupd.schema, Fcupt.schema, Fcurp.schema, Fcvlog.schema, Fcxlt.schema).reduceLeft(_ ++ _)
   ...
   *  @param actconstantvalue Database column ACTCONSTANTVALUE SqlType(VARCHAR), Length(2048,true)
  ...
  class Fcact(_tableTag: Tag) extends BaseTable[FcactRow](_tableTag, "FCACT") {
    ...
    /** Database column ACTCONSTANTVALUE SqlType(VARCHAR), Length(2048,true) */
    val actconstantvalue: Rep[String] = column[String]("ACTCONSTANTVALUE", O.Length(2048,varying=true))
   ...
   *  @param bmtbillerhelp Database column BMTBILLERHELP SqlType(VARCHAR), Length(2048,true), Default(None)
   *  @param bmtbanktype Database column BMTBANKTYPE SqlType(CHAR), Length(10,false), Default(None)
   *  @param bmtisipallowed Database column BMTISIPALLOWED SqlType(CHAR), Length(2,false)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcbmtRow(id: Long, bmtbankname: String, bmtbankcode: Option[String] = None, bmtactive: String, bmtbillerhelp: Option[String] = None, bmtbanktype: Option[String] = None, bmtisipallowed: String, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcbmtRowWrapper(id: Option[Long], bmtbankname: String, bmtbankcode: Option[String] = None, bmtactive: String, bmtbillerhelp: Option[String] = None, bmtbanktype: Option[String] = None, bmtisipallowed: String) {
    def get(userName: String): FcbmtRow = {
      FcbmtRow(this.id.getOrElse(0), this.bmtbankname, this.bmtbankcode, this.bmtactive, this.bmtbillerhelp, this.bmtbanktype, this.bmtisipallowed, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  ...
  implicit def GetResultFcbmtRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp]): GR[FcbmtRow] = GR{
    prs => import prs._
    FcbmtRow.tupled((<<[Long], <<[String], <<?[String], <<[String], <<?[String], <<?[String], <<[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcbmt(_tableTag: Tag) extends BaseTable[FcbmtRow](_tableTag, "FCBMT") {
    def * = (id, bmtbankname, bmtbankcode, bmtactive, bmtbillerhelp, bmtbanktype, bmtisipallowed, createdate, modifydate, createdby, lastmodifiedby) <> (FcbmtRow.tupled, FcbmtRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(bmtbankname), bmtbankcode, Rep.Some(bmtactive), bmtbillerhelp, bmtbanktype, Rep.Some(bmtisipallowed), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcbmtRow.tupled((_1.get, _2.get, _3, _4.get, _5, _6, _7.get, _8, _9.get, _10.get, _11.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column BMTBILLERHELP SqlType(VARCHAR), Length(2048,true), Default(None) */
    val bmtbillerhelp: Rep[Option[String]] = column[Option[String]]("BMTBILLERHELP", O.Length(2048,varying=true), O.Default(None))
    /** Database column BMTBANKTYPE SqlType(CHAR), Length(10,false), Default(None) */
    val bmtbanktype: Rep[Option[String]] = column[Option[String]]("BMTBANKTYPE", O.Length(10,varying=false), O.Default(None))
  ...
  /** Entity class storing rows of table Fcbsat
   *  @param bsatrfnum Database column BSATRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param bsataipday Database column BSATAIPDAY SqlType(VARCHAR), Length(128,true)
   *  @param bsatbserfnum Database column BSATBSERFNUM SqlType(BIGINT)
   *  @param bsatfrequency Database column BSATFREQUENCY SqlType(CHAR), Length(2,false)
   *  @param bsatmintenure Database column BSATMINTENURE SqlType(INT)
   *  @param bsattype Database column BSATTYPE SqlType(CHAR), Length(4,false)
   *  @param bsatminamount Database column BSATMINAMOUNT SqlType(INT)
   *  @param bsatadditionalamt Database column BSATADDITIONALAMT SqlType(INT)
   *  @param bsatmaxamount Database column BSATMAXAMOUNT SqlType(BIGINT)
   *  @param bsatmaxtenure Database column BSATMAXTENURE SqlType(BIGINT)
   *  @param bsatmultiplier Database column BSATMULTIPLIER SqlType(INT)
   *  @param bsatidentifier Database column BSATIDENTIFIER SqlType(CHAR), Length(10,false)
   *  @param bsatminimumgap Database column BSATMINIMUMGAP SqlType(INT)
   *  @param bsatmaximumgap Database column BSATMAXIMUMGAP SqlType(INT)
   *  @param bsatinstallmentgap Database column BSATINSTALLMENTGAP SqlType(INT)
   *  @param bsatmininstallmentnos Database column BSATMININSTALLMENTNOS SqlType(INT)
   *  @param bsatmaxinstallmentnos Database column BSATMAXINSTALLMENTNOS SqlType(INT)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcbsatRow(id: Long, bsataipday: String, bsatbserfnum: Long, bsatfrequency: String, bsatmintenure: Int, bsattype: String, bsatminamount: Int, bsatadditionalamt: Int, bsatmaxamount: Long, bsatmaxtenure: Long, bsatmultiplier: Int, bsatidentifier: String, bsatminimumgap: Int, bsatmaximumgap: Int, bsatinstallmentgap: Int, bsatmininstallmentnos: Int, bsatmaxinstallmentnos: Int, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcbsatRowWrapper(id: Option[Long], bsataipday: String, bsatbserfnum: Long, bsatfrequency: String, bsatmintenure: Int, bsattype: String, bsatminamount: Int, bsatadditionalamt: Int, bsatmaxamount: Long, bsatmaxtenure: Long, bsatmultiplier: Int, bsatidentifier: String, bsatminimumgap: Int, bsatmaximumgap: Int, bsatinstallmentgap: Int, bsatmininstallmentnos: Int, bsatmaxinstallmentnos: Int) {
    def get(userName: String): FcbsatRow = {
      FcbsatRow(this.id.getOrElse(0), this.bsataipday, this.bsatbserfnum, this.bsatfrequency, this.bsatmintenure, this.bsattype, this.bsatminamount, this.bsatadditionalamt, this.bsatmaxamount, this.bsatmaxtenure, this.bsatmultiplier, this.bsatidentifier, this.bsatminimumgap, this.bsatmaximumgap, this.bsatinstallmentgap, this.bsatmininstallmentnos, this.bsatmaxinstallmentnos, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcbsatRow objects using plain SQL queries */
  implicit def GetResultFcbsatRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Int], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp]): GR[FcbsatRow] = GR{
    prs => import prs._
    FcbsatRow.tupled((<<[Long], <<[String], <<[Long], <<[String], <<[Int], <<[String], <<[Int], <<[Int], <<[Long], <<[Long], <<[Int], <<[String], <<[Int], <<[Int], <<[Int], <<[Int], <<[Int], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCBSAT. Objects of this class serve as prototypes for rows in queries. */
  class Fcbsat(_tableTag: Tag) extends BaseTable[FcbsatRow](_tableTag, "FCBSAT") {
    def * = (id, bsataipday, bsatbserfnum, bsatfrequency, bsatmintenure, bsattype, bsatminamount, bsatadditionalamt, bsatmaxamount, bsatmaxtenure, bsatmultiplier, bsatidentifier, bsatminimumgap, bsatmaximumgap, bsatinstallmentgap, bsatmininstallmentnos, bsatmaxinstallmentnos, createdate, modifydate, createdby, lastmodifiedby) <> (FcbsatRow.tupled, FcbsatRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(bsataipday), Rep.Some(bsatbserfnum), Rep.Some(bsatfrequency), Rep.Some(bsatmintenure), Rep.Some(bsattype), Rep.Some(bsatminamount), Rep.Some(bsatadditionalamt), Rep.Some(bsatmaxamount), Rep.Some(bsatmaxtenure), Rep.Some(bsatmultiplier), Rep.Some(bsatidentifier), Rep.Some(bsatminimumgap), Rep.Some(bsatmaximumgap), Rep.Some(bsatinstallmentgap), Rep.Some(bsatmininstallmentnos), Rep.Some(bsatmaxinstallmentnos), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcbsatRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10.get, _11.get, _12.get, _13.get, _14.get, _15.get, _16.get, _17.get, _18, _19.get, _20.get, _21.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column BSATRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("BSATRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column BSATAIPDAY SqlType(VARCHAR), Length(128,true) */
    val bsataipday: Rep[String] = column[String]("BSATAIPDAY", O.Length(128,varying=true))
    /** Database column BSATBSERFNUM SqlType(BIGINT) */
    val bsatbserfnum: Rep[Long] = column[Long]("BSATBSERFNUM")
    /** Database column BSATFREQUENCY SqlType(CHAR), Length(2,false) */
    val bsatfrequency: Rep[String] = column[String]("BSATFREQUENCY", O.Length(2,varying=false))
    /** Database column BSATMINTENURE SqlType(INT) */
    val bsatmintenure: Rep[Int] = column[Int]("BSATMINTENURE")
    /** Database column BSATTYPE SqlType(CHAR), Length(4,false) */
    val bsattype: Rep[String] = column[String]("BSATTYPE", O.Length(4,varying=false))
    /** Database column BSATMINAMOUNT SqlType(INT) */
    val bsatminamount: Rep[Int] = column[Int]("BSATMINAMOUNT")
    /** Database column BSATADDITIONALAMT SqlType(INT) */
    val bsatadditionalamt: Rep[Int] = column[Int]("BSATADDITIONALAMT")
    /** Database column BSATMAXAMOUNT SqlType(BIGINT) */
    val bsatmaxamount: Rep[Long] = column[Long]("BSATMAXAMOUNT")
    /** Database column BSATMAXTENURE SqlType(BIGINT) */
    val bsatmaxtenure: Rep[Long] = column[Long]("BSATMAXTENURE")
    /** Database column BSATMULTIPLIER SqlType(INT) */
    val bsatmultiplier: Rep[Int] = column[Int]("BSATMULTIPLIER")
    /** Database column BSATIDENTIFIER SqlType(CHAR), Length(10,false) */
    val bsatidentifier: Rep[String] = column[String]("BSATIDENTIFIER", O.Length(10,varying=false))
    /** Database column BSATMINIMUMGAP SqlType(INT) */
    val bsatminimumgap: Rep[Int] = column[Int]("BSATMINIMUMGAP")
    /** Database column BSATMAXIMUMGAP SqlType(INT) */
    val bsatmaximumgap: Rep[Int] = column[Int]("BSATMAXIMUMGAP")
    /** Database column BSATINSTALLMENTGAP SqlType(INT) */
    val bsatinstallmentgap: Rep[Int] = column[Int]("BSATINSTALLMENTGAP")
    /** Database column BSATMININSTALLMENTNOS SqlType(INT) */
    val bsatmininstallmentnos: Rep[Int] = column[Int]("BSATMININSTALLMENTNOS")
    /** Database column BSATMAXINSTALLMENTNOS SqlType(INT) */
    val bsatmaxinstallmentnos: Rep[Int] = column[Int]("BSATMAXINSTALLMENTNOS")





    /** Foreign key referencing Fcbse (database name FK_FCBSAT_FCBSE) */
    lazy val fcbseFk = foreignKey("FK_FCBSAT_FCBSE", bsatbserfnum, Fcbse)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fcbsat */
  lazy val Fcbsat = new TableQuery(tag => new Fcbsat(tag))
  ...
  /** Entity class storing rows of table Fcbsuf
   *  @param bsufrfnum Database column BSUFRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param bsufebserfnum Database column BSUFEBSERFNUM SqlType(BIGINT)
   *  @param bsufsuffixcode Database column BSUFSUFFIXCODE SqlType(VARCHAR), Length(16,true)
   *  @param bsuffinalcode Database column BSUFFINALCODE SqlType(VARCHAR), Length(16,true), Default(None)
   *  @param bsufistimebased Database column BSUFISTIMEBASED SqlType(CHAR), Length(2,false)
   *  @param bsufisamountbased Database column BSUFISAMOUNTBASED SqlType(CHAR), Length(2,false)
   *  @param bsufbsecutofftime Database column BSUFBSECUTOFFTIME SqlType(TIME), Default(None)
   *  @param bsufbsefundscutoff Database column BSUFBSEFUNDSCUTOFF SqlType(TIME), Default(None)
   *  @param bsufthresoldamount Database column BSUFTHRESOLDAMOUNT SqlType(DOUBLE), Default(None)
   *  @param bsufprefixcode Database column BSUFPREFIXCODE SqlType(VARCHAR), Length(16,true), Default(None)
   *  @param bsufstpflag Database column BSUFSTPFLAG SqlType(VARCHAR), Length(2,true), Default(None)
   *  @param bsufswpflag Database column BSUFSWPFLAG SqlType(VARCHAR), Length(2,true), Default(None)
   *  @param bsufswitchflag Database column BSUFSWITCHFLAG SqlType(VARCHAR), Length(2,true), Default(None)
   *  @param bsufsettlementtype Database column BSUFSETTLEMENTTYPE SqlType(VARCHAR), Length(3,true), Default(None)
   *  @param bsufsipflag Database column BSUFSIPFLAG SqlType(VARCHAR), Length(2,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcbsufRow(id: Long, bsufebserfnum: Long, bsufsuffixcode: String, bsuffinalcode: Option[String] = None, bsufistimebased: String, bsufisamountbased: String, bsufbsecutofftime: Option[java.sql.Time] = None, bsufbsefundscutoff: Option[java.sql.Time] = None, bsufthresoldamount: Option[Double] = None, bsufprefixcode: Option[String] = None, bsufstpflag: Option[String] = None, bsufswpflag: Option[String] = None, bsufswitchflag: Option[String] = None, bsufsettlementtype: Option[String] = None, bsufsipflag: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcbsufRowWrapper(id: Option[Long], bsufebserfnum: Long, bsufsuffixcode: String, bsuffinalcode: Option[String] = None, bsufistimebased: String, bsufisamountbased: String, bsufbsecutofftime: Option[java.sql.Time] = None, bsufbsefundscutoff: Option[java.sql.Time] = None, bsufthresoldamount: Option[Double] = None, bsufprefixcode: Option[String] = None, bsufstpflag: Option[String] = None, bsufswpflag: Option[String] = None, bsufswitchflag: Option[String] = None, bsufsettlementtype: Option[String] = None, bsufsipflag: Option[String] = None) {
    def get(userName: String): FcbsufRow = {
      FcbsufRow(this.id.getOrElse(0), this.bsufebserfnum, this.bsufsuffixcode, this.bsuffinalcode, this.bsufistimebased, this.bsufisamountbased, this.bsufbsecutofftime, this.bsufbsefundscutoff, this.bsufthresoldamount, this.bsufprefixcode, this.bsufstpflag, this.bsufswpflag, this.bsufswitchflag, this.bsufsettlementtype, this.bsufsipflag, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcbsufRow objects using plain SQL queries */
  implicit def GetResultFcbsufRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[java.sql.Time]], e4: GR[Option[Double]], e5: GR[Option[java.sql.Timestamp]], e6: GR[java.sql.Timestamp]): GR[FcbsufRow] = GR{
    prs => import prs._
    FcbsufRow.tupled((<<[Long], <<[Long], <<[String], <<?[String], <<[String], <<[String], <<?[java.sql.Time], <<?[java.sql.Time], <<?[Double], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCBSUF. Objects of this class serve as prototypes for rows in queries. */
  class Fcbsuf(_tableTag: Tag) extends BaseTable[FcbsufRow](_tableTag, "FCBSUF") {
    def * = (id, bsufebserfnum, bsufsuffixcode, bsuffinalcode, bsufistimebased, bsufisamountbased, bsufbsecutofftime, bsufbsefundscutoff, bsufthresoldamount, bsufprefixcode, bsufstpflag, bsufswpflag, bsufswitchflag, bsufsettlementtype, bsufsipflag, createdate, modifydate, createdby, lastmodifiedby) <> (FcbsufRow.tupled, FcbsufRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(bsufebserfnum), Rep.Some(bsufsuffixcode), bsuffinalcode, Rep.Some(bsufistimebased), Rep.Some(bsufisamountbased), bsufbsecutofftime, bsufbsefundscutoff, bsufthresoldamount, bsufprefixcode, bsufstpflag, bsufswpflag, bsufswitchflag, bsufsettlementtype, bsufsipflag, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcbsufRow.tupled((_1.get, _2.get, _3.get, _4, _5.get, _6.get, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17.get, _18.get, _19.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column BSUFRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("BSUFRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column BSUFEBSERFNUM SqlType(BIGINT) */
    val bsufebserfnum: Rep[Long] = column[Long]("BSUFEBSERFNUM")
    /** Database column BSUFSUFFIXCODE SqlType(VARCHAR), Length(16,true) */
    val bsufsuffixcode: Rep[String] = column[String]("BSUFSUFFIXCODE", O.Length(16,varying=true))
    /** Database column BSUFFINALCODE SqlType(VARCHAR), Length(16,true), Default(None) */
    val bsuffinalcode: Rep[Option[String]] = column[Option[String]]("BSUFFINALCODE", O.Length(16,varying=true), O.Default(None))
    /** Database column BSUFISTIMEBASED SqlType(CHAR), Length(2,false) */
    val bsufistimebased: Rep[String] = column[String]("BSUFISTIMEBASED", O.Length(2,varying=false))
    /** Database column BSUFISAMOUNTBASED SqlType(CHAR), Length(2,false) */
    val bsufisamountbased: Rep[String] = column[String]("BSUFISAMOUNTBASED", O.Length(2,varying=false))
    /** Database column BSUFBSECUTOFFTIME SqlType(TIME), Default(None) */
    val bsufbsecutofftime: Rep[Option[java.sql.Time]] = column[Option[java.sql.Time]]("BSUFBSECUTOFFTIME", O.Default(None))
    /** Database column BSUFBSEFUNDSCUTOFF SqlType(TIME), Default(None) */
    val bsufbsefundscutoff: Rep[Option[java.sql.Time]] = column[Option[java.sql.Time]]("BSUFBSEFUNDSCUTOFF", O.Default(None))
    /** Database column BSUFTHRESOLDAMOUNT SqlType(DOUBLE), Default(None) */
    val bsufthresoldamount: Rep[Option[Double]] = column[Option[Double]]("BSUFTHRESOLDAMOUNT", O.Default(None))
    /** Database column BSUFPREFIXCODE SqlType(VARCHAR), Length(16,true), Default(None) */
    val bsufprefixcode: Rep[Option[String]] = column[Option[String]]("BSUFPREFIXCODE", O.Length(16,varying=true), O.Default(None))
    /** Database column BSUFSTPFLAG SqlType(VARCHAR), Length(2,true), Default(None) */
    val bsufstpflag: Rep[Option[String]] = column[Option[String]]("BSUFSTPFLAG", O.Length(2,varying=true), O.Default(None))
    /** Database column BSUFSWPFLAG SqlType(VARCHAR), Length(2,true), Default(None) */
    val bsufswpflag: Rep[Option[String]] = column[Option[String]]("BSUFSWPFLAG", O.Length(2,varying=true), O.Default(None))
    /** Database column BSUFSWITCHFLAG SqlType(VARCHAR), Length(2,true), Default(None) */
    val bsufswitchflag: Rep[Option[String]] = column[Option[String]]("BSUFSWITCHFLAG", O.Length(2,varying=true), O.Default(None))
    /** Database column BSUFSETTLEMENTTYPE SqlType(VARCHAR), Length(3,true), Default(None) */
    val bsufsettlementtype: Rep[Option[String]] = column[Option[String]]("BSUFSETTLEMENTTYPE", O.Length(3,varying=true), O.Default(None))
    /** Database column BSUFSIPFLAG SqlType(VARCHAR), Length(2,true), Default(None) */
    val bsufsipflag: Rep[Option[String]] = column[Option[String]]("BSUFSIPFLAG", O.Length(2,varying=true), O.Default(None))





    /** Foreign key referencing Fcebse (database name FK_FCBSUF_FCEBSE) */
    lazy val fcebseFk = foreignKey("FK_FCBSUF_FCEBSE", bsufebserfnum, Fcebse)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)

    /** Uniqueness Index over (bsufebserfnum) (database name BSUF_EBSE_UNQ) */
    val index1 = index("BSUF_EBSE_UNQ", bsufebserfnum, unique=true)
  }
  /** Collection-like TableQuery object for table Fcbsuf */
  lazy val Fcbsuf = new TableQuery(tag => new Fcbsuf(tag))
   ...
   *  @param cndrfnum Database column CNDRFNUM SqlType(BIGINT), PrimaryKey
  ...
  class FccndRowWrapper(id: Long, cndsequence: Option[Float] = None, cndname: String, cnddesc: Option[String] = None, cndgroup: String, cndactive: String, cndcndrfnum: Option[Long] = None, cndextfld1: Option[String] = None, cndextfld2: Option[String] = None, cndextfld3: Option[Long] = None, cndextfld4: Option[Long] = None, cndcode: Option[String] = None) {
    def get(userName: String): FccndRow = {
      FccndRow(this.id, this.cndsequence, this.cndname, this.cnddesc, this.cndgroup, this.cndactive, this.cndcndrfnum, this.cndextfld1, this.cndextfld2, this.cndextfld3, this.cndextfld4, this.cndcode, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  ...
  class Fccnd(_tableTag: Tag) extends BaseTable[FccndRow](_tableTag, "FCCND") {
    ...
    /** Database column CNDRFNUM SqlType(BIGINT), PrimaryKey */
    override val id: Rep[Long] = column[Long]("CNDRFNUM", O.PrimaryKey)
  ...
  /** Entity class storing rows of table Fccrt
   *  @param crtrfnum Database column CRTRFNUM SqlType(BIGINT), PrimaryKey
   *  @param crtctmtrfnum Database column CRTCTMTRFNUM SqlType(BIGINT)
   *  @param crtranking Database column CRTRANKING SqlType(INT)
   *  @param crtsmtrfnum Database column CRTSMTRFNUM SqlType(BIGINT)
   *  @param crtratingdate Database column CRTRATINGDATE SqlType(DATE)
   *  @param crtvalidtill Database column CRTVALIDTILL SqlType(DATE)
   *  @param crtratingdesc Database column CRTRATINGDESC SqlType(VARCHAR), Length(1024,true), Default(None)
   *  @param crtratingmean Database column CRTRATINGMEAN SqlType(VARCHAR), Length(50,true), Default(None)
   *  @param crttotalfunds Database column CRTTOTALFUNDS SqlType(INT), Default(None)
   *  @param crtremark Database column CRTREMARK SqlType(VARCHAR), Length(512,true), Default(None)
   *  @param crttooltipdesc Database column CRTTOOLTIPDESC SqlType(VARCHAR), Length(512,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FccrtRow(id: Long, crtctmtrfnum: Long, crtranking: Int, crtsmtrfnum: Long, crtratingdate: java.sql.Date, crtvalidtill: java.sql.Date, crtratingdesc: Option[String] = None, crtratingmean: Option[String] = None, crttotalfunds: Option[Int] = None, crtremark: Option[String] = None, crttooltipdesc: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FccrtRowWrapper(id: Long, crtctmtrfnum: Long, crtranking: Int, crtsmtrfnum: Long, crtratingdate: java.sql.Date, crtvalidtill: java.sql.Date, crtratingdesc: Option[String] = None, crtratingmean: Option[String] = None, crttotalfunds: Option[Int] = None, crtremark: Option[String] = None, crttooltipdesc: Option[String] = None) {
    def get(userName: String): FccrtRow = {
      FccrtRow(this.id, this.crtctmtrfnum, this.crtranking, this.crtsmtrfnum, this.crtratingdate, this.crtvalidtill, this.crtratingdesc, this.crtratingmean, this.crttotalfunds, this.crtremark, this.crttooltipdesc, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FccrtRow objects using plain SQL queries */
  implicit def GetResultFccrtRow(implicit e0: GR[Long], e1: GR[Int], e2: GR[java.sql.Date], e3: GR[Option[String]], e4: GR[Option[Int]], e5: GR[Option[java.sql.Timestamp]], e6: GR[java.sql.Timestamp], e7: GR[String]): GR[FccrtRow] = GR{
    prs => import prs._
    FccrtRow.tupled((<<[Long], <<[Long], <<[Int], <<[Long], <<[java.sql.Date], <<[java.sql.Date], <<?[String], <<?[String], <<?[Int], <<?[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCCRT. Objects of this class serve as prototypes for rows in queries. */
  class Fccrt(_tableTag: Tag) extends BaseTable[FccrtRow](_tableTag, "FCCRT") {
    def * = (id, crtctmtrfnum, crtranking, crtsmtrfnum, crtratingdate, crtvalidtill, crtratingdesc, crtratingmean, crttotalfunds, crtremark, crttooltipdesc, createdate, modifydate, createdby, lastmodifiedby) <> (FccrtRow.tupled, FccrtRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(crtctmtrfnum), Rep.Some(crtranking), Rep.Some(crtsmtrfnum), Rep.Some(crtratingdate), Rep.Some(crtvalidtill), crtratingdesc, crtratingmean, crttotalfunds, crtremark, crttooltipdesc, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FccrtRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7, _8, _9, _10, _11, _12, _13.get, _14.get, _15.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column CRTRFNUM SqlType(BIGINT), PrimaryKey */
    override val id: Rep[Long] = column[Long]("CRTRFNUM", O.PrimaryKey)
    /** Database column CRTCTMTRFNUM SqlType(BIGINT) */
    val crtctmtrfnum: Rep[Long] = column[Long]("CRTCTMTRFNUM")
    /** Database column CRTRANKING SqlType(INT) */
    val crtranking: Rep[Int] = column[Int]("CRTRANKING")
    /** Database column CRTSMTRFNUM SqlType(BIGINT) */
    val crtsmtrfnum: Rep[Long] = column[Long]("CRTSMTRFNUM")
    /** Database column CRTRATINGDATE SqlType(DATE) */
    val crtratingdate: Rep[java.sql.Date] = column[java.sql.Date]("CRTRATINGDATE")
    /** Database column CRTVALIDTILL SqlType(DATE) */
    val crtvalidtill: Rep[java.sql.Date] = column[java.sql.Date]("CRTVALIDTILL")
    /** Database column CRTRATINGDESC SqlType(VARCHAR), Length(1024,true), Default(None) */
    val crtratingdesc: Rep[Option[String]] = column[Option[String]]("CRTRATINGDESC", O.Length(1024,varying=true), O.Default(None))
    /** Database column CRTRATINGMEAN SqlType(VARCHAR), Length(50,true), Default(None) */
    val crtratingmean: Rep[Option[String]] = column[Option[String]]("CRTRATINGMEAN", O.Length(50,varying=true), O.Default(None))
    /** Database column CRTTOTALFUNDS SqlType(INT), Default(None) */
    val crttotalfunds: Rep[Option[Int]] = column[Option[Int]]("CRTTOTALFUNDS", O.Default(None))
    /** Database column CRTREMARK SqlType(VARCHAR), Length(512,true), Default(None) */
    val crtremark: Rep[Option[String]] = column[Option[String]]("CRTREMARK", O.Length(512,varying=true), O.Default(None))
    /** Database column CRTTOOLTIPDESC SqlType(VARCHAR), Length(512,true), Default(None) */
    val crttooltipdesc: Rep[Option[String]] = column[Option[String]]("CRTTOOLTIPDESC", O.Length(512,varying=true), O.Default(None))





    /** Foreign key referencing Fcctmt (database name FK_FCCRT_FCCTMT) */
    lazy val fcctmtFk = foreignKey("FK_FCCRT_FCCTMT", crtctmtrfnum, Fcctmt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcsmt (database name FK_FCCRT_FCSMT) */
    lazy val fcsmtFk = foreignKey("FK_FCCRT_FCSMT", crtsmtrfnum, Fcsmt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fccrt */
  lazy val Fccrt = new TableQuery(tag => new Fccrt(tag))
   ...
   *  @param dmtuploadip Database column DMTUPLOADIP SqlType(VARCHAR), Length(32,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcdmtRow(id: Long, dmtcndtyperfnum: Long, dmtpath: Option[String] = None, dmtbackuppath: Option[String] = None, dmtissuauthority: Option[String] = None, dmtissuedate: Option[java.sql.Date] = None, dmtdocvalidity: Option[java.sql.Date] = None, dmtuploadip: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcdmtRowWrapper(id: Option[Long], dmtcndtyperfnum: Long, dmtpath: Option[String] = None, dmtbackuppath: Option[String] = None, dmtissuauthority: Option[String] = None, dmtissuedate: Option[java.sql.Date] = None, dmtdocvalidity: Option[java.sql.Date] = None, dmtuploadip: Option[String] = None) {
    def get(userName: String): FcdmtRow = {
      FcdmtRow(this.id.getOrElse(0), this.dmtcndtyperfnum, this.dmtpath, this.dmtbackuppath, this.dmtissuauthority, this.dmtissuedate, this.dmtdocvalidity, this.dmtuploadip, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  ...
  implicit def GetResultFcdmtRow(implicit e0: GR[Long], e1: GR[Option[String]], e2: GR[Option[java.sql.Date]], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp], e5: GR[String]): GR[FcdmtRow] = GR{
    prs => import prs._
    FcdmtRow.tupled((<<[Long], <<[Long], <<?[String], <<?[String], <<?[String], <<?[java.sql.Date], <<?[java.sql.Date], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcdmt(_tableTag: Tag) extends BaseTable[FcdmtRow](_tableTag, "FCDMT") {
    def * = (id, dmtcndtyperfnum, dmtpath, dmtbackuppath, dmtissuauthority, dmtissuedate, dmtdocvalidity, dmtuploadip, createdate, modifydate, createdby, lastmodifiedby) <> (FcdmtRow.tupled, FcdmtRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(dmtcndtyperfnum), dmtpath, dmtbackuppath, dmtissuauthority, dmtissuedate, dmtdocvalidity, dmtuploadip, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcdmtRow.tupled((_1.get, _2.get, _3, _4, _5, _6, _7, _8, _9, _10.get, _11.get, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column DMTUPLOADIP SqlType(VARCHAR), Length(32,true), Default(None) */
    val dmtuploadip: Rep[Option[String]] = column[Option[String]]("DMTUPLOADIP", O.Length(32,varying=true), O.Default(None))
   ...
   *  @param fhstradedate Database column FHSTRADEDATE SqlType(DATE)
   *  @param fhsexitload Database column FHSEXITLOAD SqlType(DOUBLE), Default(None)
   *  @param fhsrtasystematicref Database column FHSRTASYSTEMATICREF SqlType(CHAR), Length(20,false), Default(None)
   ...
   *  @param createdate 
   *  @param fhsfrlrfnum Database column FHSFRLRFNUM SqlType(BIGINT)
   *  @param fhsexternalorderid Database column FHSEXTERNALORDERID SqlType(CHAR), Length(32,false) */
  case class FcfhsRow(id: Long, fhstype: String, fhsunits: Double, fhsrtarefnum: String, fhstradedate: java.sql.Date, fhsexitload: Option[Double] = None, fhsrtasystematicref: Option[String] = None, fhssotrfnum: Option[Long] = None, fhssoptrfnum: Long, fhsprice: Double, fhsamount: Double, fhsdescription: Option[String] = None, fhspostdate: java.sql.Date, fhsrtareportdate: java.sql.Date, fhstransactionmode: String, fhstransactiontype: String, fhsfhtrfnum: Long, fhsrtasequenceno: String, fhsstt: Double, createdate: Option[java.sql.Timestamp] = None, fhsfrlrfnum: Long, fhsexternalorderid: String) extends BaseEntity 
  class FcfhsRowWrapper(id: Option[Long], fhstype: String, fhsunits: Double, fhsrtarefnum: String, fhstradedate: java.sql.Date, fhsexitload: Option[Double] = None, fhsrtasystematicref: Option[String] = None, fhssotrfnum: Option[Long] = None, fhssoptrfnum: Long, fhsprice: Double, fhsamount: Double, fhsdescription: Option[String] = None, fhspostdate: java.sql.Date, fhsrtareportdate: java.sql.Date, fhstransactionmode: String, fhstransactiontype: String, fhsfhtrfnum: Long, fhsrtasequenceno: String, fhsstt: Double, fhsfrlrfnum: Long, fhsexternalorderid: String) {
    def get(userName: String): FcfhsRow = {
      FcfhsRow(this.id.getOrElse(0), this.fhstype, this.fhsunits, this.fhsrtarefnum, this.fhstradedate, this.fhsexitload, this.fhsrtasystematicref, this.fhssotrfnum, this.fhssoptrfnum, this.fhsprice, this.fhsamount, this.fhsdescription, this.fhspostdate, this.fhsrtareportdate, this.fhstransactionmode, this.fhstransactiontype, this.fhsfhtrfnum, this.fhsrtasequenceno, this.fhsstt, Some(DateTimeUtils.getCurrentTimeStamp), this.fhsfrlrfnum, this.fhsexternalorderid)
  	}
  }
  /** GetResult implicit for fetching FcfhsRow objects using plain SQL queries */
  implicit def GetResultFcfhsRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Double], e3: GR[java.sql.Date], e4: GR[Option[Double]], e5: GR[Option[String]], e6: GR[Option[Long]], e7: GR[Option[java.sql.Timestamp]]): GR[FcfhsRow] = GR{
    prs => import prs._
    FcfhsRow.tupled((<<[Long], <<[String], <<[Double], <<[String], <<[java.sql.Date], <<?[Double], <<?[String], <<?[Long], <<[Long], <<[Double], <<[Double], <<?[String], <<[java.sql.Date], <<[java.sql.Date], <<[String], <<[String], <<[Long], <<[String], <<[Double], <<?[java.sql.Timestamp], <<[Long], <<[String]))
  }
  ...
  class Fcfhs(_tableTag: Tag) extends BaseTable[FcfhsRow](_tableTag, "FCFHS") {
    def * = (id, fhstype, fhsunits, fhsrtarefnum, fhstradedate, fhsexitload, fhsrtasystematicref, fhssotrfnum, fhssoptrfnum, fhsprice, fhsamount, fhsdescription, fhspostdate, fhsrtareportdate, fhstransactionmode, fhstransactiontype, fhsfhtrfnum, fhsrtasequenceno, fhsstt, createdate, fhsfrlrfnum, fhsexternalorderid) <> (FcfhsRow.tupled, FcfhsRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(fhstype), Rep.Some(fhsunits), Rep.Some(fhsrtarefnum), Rep.Some(fhstradedate), fhsexitload, fhsrtasystematicref, fhssotrfnum, Rep.Some(fhssoptrfnum), Rep.Some(fhsprice), Rep.Some(fhsamount), fhsdescription, Rep.Some(fhspostdate), Rep.Some(fhsrtareportdate), Rep.Some(fhstransactionmode), Rep.Some(fhstransactiontype), Rep.Some(fhsfhtrfnum), Rep.Some(fhsrtasequenceno), Rep.Some(fhsstt), createdate, Rep.Some(fhsfrlrfnum), Rep.Some(fhsexternalorderid)).shaped.<>({r=>import r._; _1.map(_=> FcfhsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7, _8, _9.get, _10.get, _11.get, _12, _13.get, _14.get, _15.get, _16.get, _17.get, _18.get, _19.get, _20, _21.get, _22.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column FHSTRADEDATE SqlType(DATE) */
    val fhstradedate: Rep[java.sql.Date] = column[java.sql.Date]("FHSTRADEDATE")
    /** Database column FHSEXITLOAD SqlType(DOUBLE), Default(None) */
    val fhsexitload: Rep[Option[Double]] = column[Option[Double]]("FHSEXITLOAD", O.Default(None))
    /** Database column FHSRTASYSTEMATICREF SqlType(CHAR), Length(20,false), Default(None) */
    val fhsrtasystematicref: Rep[Option[String]] = column[Option[String]]("FHSRTASYSTEMATICREF", O.Length(20,varying=false), O.Default(None))
    ...
    /** Database column FHSFRLRFNUM SqlType(BIGINT) */
    val fhsfrlrfnum: Rep[Long] = column[Long]("FHSFRLRFNUM")
    /** Database column FHSEXTERNALORDERID SqlType(CHAR), Length(32,false) */
    val fhsexternalorderid: Rep[String] = column[String]("FHSEXTERNALORDERID", O.Length(32,varying=false))
    ...
    /** Foreign key referencing Fcfrl (database name FK_FCFHS_FCFRL) */
    lazy val fcfrlFk = foreignKey("FK_FCFHS_FCFRL", fhsfrlrfnum, Fcfrl)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
   ...
   *  @param fhtinitialunits Database column FHTINITIALUNITS SqlType(DOUBLE)
   ...
   *  @param fhtrtasystematicref Database column FHTRTASYSTEMATICREF SqlType(CHAR), Length(20,false), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcfhtRow(id: Long, fhtholdingname: Option[String] = None, fhtinitialunits: Double, fhtholdingunits: Double, fhttradedate: java.sql.Date, fhtcomstructjson: Option[String] = None, fhtsoptrfnum: Long, fhtinvestmentmode: String, fhtjsonname: Option[String] = None, fhtfomtrfnum: Long, fhtsotrfnum: Option[Long] = None, fhtinvlocation: String, fhtstatus: String, fhtrtasystematicref: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcfhtRowWrapper(id: Option[Long], fhtholdingname: Option[String] = None, fhtinitialunits: Double, fhtholdingunits: Double, fhttradedate: java.sql.Date, fhtcomstructjson: Option[String] = None, fhtsoptrfnum: Long, fhtinvestmentmode: String, fhtjsonname: Option[String] = None, fhtfomtrfnum: Long, fhtsotrfnum: Option[Long] = None, fhtinvlocation: String, fhtstatus: String, fhtrtasystematicref: Option[String] = None) {
    def get(userName: String): FcfhtRow = {
      FcfhtRow(this.id.getOrElse(0), this.fhtholdingname, this.fhtinitialunits, this.fhtholdingunits, this.fhttradedate, this.fhtcomstructjson, this.fhtsoptrfnum, this.fhtinvestmentmode, this.fhtjsonname, this.fhtfomtrfnum, this.fhtsotrfnum, this.fhtinvlocation, this.fhtstatus, this.fhtrtasystematicref, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  ...
  implicit def GetResultFcfhtRow(implicit e0: GR[Long], e1: GR[Option[String]], e2: GR[Double], e3: GR[java.sql.Date], e4: GR[String], e5: GR[Option[Long]], e6: GR[Option[java.sql.Timestamp]], e7: GR[java.sql.Timestamp]): GR[FcfhtRow] = GR{
    prs => import prs._
    FcfhtRow.tupled((<<[Long], <<?[String], <<[Double], <<[Double], <<[java.sql.Date], <<?[String], <<[Long], <<[String], <<?[String], <<[Long], <<?[Long], <<[String], <<[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcfht(_tableTag: Tag) extends BaseTable[FcfhtRow](_tableTag, "FCFHT") {
    def * = (id, fhtholdingname, fhtinitialunits, fhtholdingunits, fhttradedate, fhtcomstructjson, fhtsoptrfnum, fhtinvestmentmode, fhtjsonname, fhtfomtrfnum, fhtsotrfnum, fhtinvlocation, fhtstatus, fhtrtasystematicref, createdate, modifydate, createdby, lastmodifiedby) <> (FcfhtRow.tupled, FcfhtRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), fhtholdingname, Rep.Some(fhtinitialunits), Rep.Some(fhtholdingunits), Rep.Some(fhttradedate), fhtcomstructjson, Rep.Some(fhtsoptrfnum), Rep.Some(fhtinvestmentmode), fhtjsonname, Rep.Some(fhtfomtrfnum), fhtsotrfnum, Rep.Some(fhtinvlocation), Rep.Some(fhtstatus), fhtrtasystematicref, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcfhtRow.tupled((_1.get, _2, _3.get, _4.get, _5.get, _6, _7.get, _8.get, _9, _10.get, _11, _12.get, _13.get, _14, _15, _16.get, _17.get, _18.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column FHTINITIALUNITS SqlType(DOUBLE) */
    val fhtinitialunits: Rep[Double] = column[Double]("FHTINITIALUNITS")
    ...
    /** Database column FHTRTASYSTEMATICREF SqlType(CHAR), Length(20,false), Default(None) */
    val fhtrtasystematicref: Rep[Option[String]] = column[Option[String]]("FHTRTASYSTEMATICREF", O.Length(20,varying=false), O.Default(None))
  ...
  /** Entity class storing rows of table Fcfome
   *  @param fomerfnum Database column FOMERFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param fomefhtrfnum Database column FOMEFHTRFNUM SqlType(BIGINT)
   *  @param fomefomtrfnum Database column FOMEFOMTRFNUM SqlType(BIGINT)
   *  @param fomertarefnum Database column FOMERTAREFNUM SqlType(VARCHAR), Length(32,true)
   *  @param fomertasequenceno Database column FOMERTASEQUENCENO SqlType(VARCHAR), Length(32,true)
   *  @param fomepostdate Database column FOMEPOSTDATE SqlType(DATE)
   *  @param fometransactionmode Database column FOMETRANSACTIONMODE SqlType(CHAR), Length(2,false)
   *  @param fometransactiontype Database column FOMETRANSACTIONTYPE SqlType(CHAR), Length(8,false)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcfomeRow(id: Long, fomefhtrfnum: Long, fomefomtrfnum: Long, fomertarefnum: String, fomertasequenceno: String, fomepostdate: java.sql.Date, fometransactionmode: String, fometransactiontype: String, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcfomeRowWrapper(id: Option[Long], fomefhtrfnum: Long, fomefomtrfnum: Long, fomertarefnum: String, fomertasequenceno: String, fomepostdate: java.sql.Date, fometransactionmode: String, fometransactiontype: String) {
    def get(userName: String): FcfomeRow = {
      FcfomeRow(this.id.getOrElse(0), this.fomefhtrfnum, this.fomefomtrfnum, this.fomertarefnum, this.fomertasequenceno, this.fomepostdate, this.fometransactionmode, this.fometransactiontype, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcfomeRow objects using plain SQL queries */
  implicit def GetResultFcfomeRow(implicit e0: GR[Long], e1: GR[String], e2: GR[java.sql.Date], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp]): GR[FcfomeRow] = GR{
    prs => import prs._
    FcfomeRow.tupled((<<[Long], <<[Long], <<[Long], <<[String], <<[String], <<[java.sql.Date], <<[String], <<[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCFOME. Objects of this class serve as prototypes for rows in queries. */
  class Fcfome(_tableTag: Tag) extends BaseTable[FcfomeRow](_tableTag, "FCFOME") {
    def * = (id, fomefhtrfnum, fomefomtrfnum, fomertarefnum, fomertasequenceno, fomepostdate, fometransactionmode, fometransactiontype, createdate, modifydate, createdby, lastmodifiedby) <> (FcfomeRow.tupled, FcfomeRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(fomefhtrfnum), Rep.Some(fomefomtrfnum), Rep.Some(fomertarefnum), Rep.Some(fomertasequenceno), Rep.Some(fomepostdate), Rep.Some(fometransactionmode), Rep.Some(fometransactiontype), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcfomeRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9, _10.get, _11.get, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column FOMERFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("FOMERFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column FOMEFHTRFNUM SqlType(BIGINT) */
    val fomefhtrfnum: Rep[Long] = column[Long]("FOMEFHTRFNUM")
    /** Database column FOMEFOMTRFNUM SqlType(BIGINT) */
    val fomefomtrfnum: Rep[Long] = column[Long]("FOMEFOMTRFNUM")
    /** Database column FOMERTAREFNUM SqlType(VARCHAR), Length(32,true) */
    val fomertarefnum: Rep[String] = column[String]("FOMERTAREFNUM", O.Length(32,varying=true))
    /** Database column FOMERTASEQUENCENO SqlType(VARCHAR), Length(32,true) */
    val fomertasequenceno: Rep[String] = column[String]("FOMERTASEQUENCENO", O.Length(32,varying=true))
    /** Database column FOMEPOSTDATE SqlType(DATE) */
    val fomepostdate: Rep[java.sql.Date] = column[java.sql.Date]("FOMEPOSTDATE")
    /** Database column FOMETRANSACTIONMODE SqlType(CHAR), Length(2,false) */
    val fometransactionmode: Rep[String] = column[String]("FOMETRANSACTIONMODE", O.Length(2,varying=false))
    /** Database column FOMETRANSACTIONTYPE SqlType(CHAR), Length(8,false) */
    val fometransactiontype: Rep[String] = column[String]("FOMETRANSACTIONTYPE", O.Length(8,varying=false))





    /** Foreign key referencing Fcfht (database name FK_FCFOME_FCFHT) */
    lazy val fcfhtFk = foreignKey("FK_FCFOME_FCFHT", fomefhtrfnum, Fcfht)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcfomt (database name FK_FCFOME_FCFOMT) */
    lazy val fcfomtFk = foreignKey("FK_FCFOME_FCFOMT", fomefomtrfnum, Fcfomt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fcfome */
  lazy val Fcfome = new TableQuery(tag => new Fcfome(tag))
  ...
  implicit def GetResultFcfomtRow(implicit e0: GR[Long], e1: GR[Option[String]], e2: GR[String], e3: GR[Option[Long]], e4: GR[Option[java.sql.Timestamp]], e5: GR[java.sql.Timestamp]): GR[FcfomtRow] = GR{
    prs => import prs._
    FcfomtRow.tupled((<<[Long], <<?[String], <<[String], <<?[String], <<?[String], <<?[String], <<[Long], <<?[Long], <<[String], <<?[Long], <<?[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String], <<?[Long]))
  }
  ...
  class Fcfomt(_tableTag: Tag) extends BaseTable[FcfomtRow](_tableTag, "FCFOMT") {
    def * = (id, fomtfolioname, fomtfoliono, fomtfoliodescp, fomtcreationdate, fomtamcname, fomtamctrfnum, fomtomtrfnum, fomtmodeofholding, fomtsotrfnum, fomtjointpan1, fomtjointpan2, createdate, modifydate, createdby, lastmodifiedby, fomtmergedrfnum) <> (FcfomtRow.tupled, FcfomtRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), fomtfolioname, Rep.Some(fomtfoliono), fomtfoliodescp, fomtcreationdate, fomtamcname, Rep.Some(fomtamctrfnum), fomtomtrfnum, Rep.Some(fomtmodeofholding), fomtsotrfnum, fomtjointpan1, fomtjointpan2, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby), fomtmergedrfnum).shaped.<>({r=>import r._; _1.map(_=> FcfomtRow.tupled((_1.get, _2, _3.get, _4, _5, _6, _7.get, _8, _9.get, _10, _11, _12, _13, _14.get, _15.get, _16.get, _17)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column FOMTMERGEDRFNUM SqlType(BIGINT), Default(None) */
    val fomtmergedrfnum: Rep[Option[Long]] = column[Option[Long]]("FOMTMERGEDRFNUM", O.Default(None))
    ...
    /** Foreign key referencing Fcfomt (database name FK_FCFOMT_FCFOMT) */
    lazy val fcfomtFk = foreignKey("FK_FCFOMT_FCFOMT", fomtmergedrfnum, Fcfomt)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
   ...
   *  @param fptrtarefnum Database column FPTRTAREFNUM SqlType(VARCHAR), Length(32,true)
   *  @param fpttype Database column FPTTYPE SqlType(CHAR), Length(2,false)
   *  @param fptamount Database column FPTAMOUNT SqlType(DOUBLE)
   *  @param fptpayoutdate Database column FPTPAYOUTDATE SqlType(DATE)
   *  @param fptreportdate Database column FPTREPORTDATE SqlType(DATE)
   *  @param fptrtasequenceno Database column FPTRTASEQUENCENO SqlType(VARCHAR), Length(32,true)
   *  @param fptremarks Database column FPTREMARKS SqlType(VARCHAR), Length(256,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby 
   *  @param fptfrlrfnum Database column FPTFRLRFNUM SqlType(BIGINT) */
  case class FcfptRow(id: Long, fptfomtrfnum: Long, fptsoptrfnum: Long, fptrtarefnum: String, fpttype: String, fptamount: Double, fptpayoutdate: java.sql.Date, fptreportdate: java.sql.Date, fptrtasequenceno: String, fptremarks: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String, fptfrlrfnum: Long) extends BaseEntity 
  class FcfptRowWrapper(id: Option[Long], fptfomtrfnum: Long, fptsoptrfnum: Long, fptrtarefnum: String, fpttype: String, fptamount: Double, fptpayoutdate: java.sql.Date, fptreportdate: java.sql.Date, fptrtasequenceno: String, fptremarks: Option[String] = None, fptfrlrfnum: Long) {
    def get(userName: String): FcfptRow = {
      FcfptRow(this.id.getOrElse(0), this.fptfomtrfnum, this.fptsoptrfnum, this.fptrtarefnum, this.fpttype, this.fptamount, this.fptpayoutdate, this.fptreportdate, this.fptrtasequenceno, this.fptremarks, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName, this.fptfrlrfnum)
  	}
  }
  /** GetResult implicit for fetching FcfptRow objects using plain SQL queries */
  implicit def GetResultFcfptRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Double], e3: GR[java.sql.Date], e4: GR[Option[String]], e5: GR[Option[java.sql.Timestamp]], e6: GR[java.sql.Timestamp]): GR[FcfptRow] = GR{
    prs => import prs._
    FcfptRow.tupled((<<[Long], <<[Long], <<[Long], <<[String], <<[String], <<[Double], <<[java.sql.Date], <<[java.sql.Date], <<[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String], <<[Long]))
  }
  ...
  class Fcfpt(_tableTag: Tag) extends BaseTable[FcfptRow](_tableTag, "FCFPT") {
    def * = (id, fptfomtrfnum, fptsoptrfnum, fptrtarefnum, fpttype, fptamount, fptpayoutdate, fptreportdate, fptrtasequenceno, fptremarks, createdate, modifydate, createdby, lastmodifiedby, fptfrlrfnum) <> (FcfptRow.tupled, FcfptRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(fptfomtrfnum), Rep.Some(fptsoptrfnum), Rep.Some(fptrtarefnum), Rep.Some(fpttype), Rep.Some(fptamount), Rep.Some(fptpayoutdate), Rep.Some(fptreportdate), Rep.Some(fptrtasequenceno), fptremarks, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby), Rep.Some(fptfrlrfnum)).shaped.<>({r=>import r._; _1.map(_=> FcfptRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10, _11, _12.get, _13.get, _14.get, _15.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column FPTRTAREFNUM SqlType(VARCHAR), Length(32,true) */
    val fptrtarefnum: Rep[String] = column[String]("FPTRTAREFNUM", O.Length(32,varying=true))
    /** Database column FPTTYPE SqlType(CHAR), Length(2,false) */
    val fpttype: Rep[String] = column[String]("FPTTYPE", O.Length(2,varying=false))
    /** Database column FPTAMOUNT SqlType(DOUBLE) */
    val fptamount: Rep[Double] = column[Double]("FPTAMOUNT")
    /** Database column FPTPAYOUTDATE SqlType(DATE) */
    val fptpayoutdate: Rep[java.sql.Date] = column[java.sql.Date]("FPTPAYOUTDATE")
    /** Database column FPTREPORTDATE SqlType(DATE) */
    val fptreportdate: Rep[java.sql.Date] = column[java.sql.Date]("FPTREPORTDATE")
    /** Database column FPTRTASEQUENCENO SqlType(VARCHAR), Length(32,true) */
    val fptrtasequenceno: Rep[String] = column[String]("FPTRTASEQUENCENO", O.Length(32,varying=true))
    /** Database column FPTREMARKS SqlType(VARCHAR), Length(256,true), Default(None) */
    val fptremarks: Rep[Option[String]] = column[Option[String]]("FPTREMARKS", O.Length(256,varying=true), O.Default(None))




    /** Database column FPTFRLRFNUM SqlType(BIGINT) */
    val fptfrlrfnum: Rep[Long] = column[Long]("FPTFRLRFNUM")
    ...
    /** Foreign key referencing Fcfrl (database name FK_FCFPT_FCFRL) */
    lazy val fcfrlFk = foreignKey("FK_FCFPT_FCFRL", fptfrlrfnum, Fcfrl)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  ...
  /** Entity class storing rows of table Fcfrl
   *  @param frlrfnum Database column FRLRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param frlrtarfnum Database column FRLRTARFNUM SqlType(BIGINT), Default(None)
   *  @param frlfilepath Database column FRLFILEPATH SqlType(VARCHAR), Length(512,true)
   *  @param frlreversalrfnum Database column FRLREVERSALRFNUM SqlType(BIGINT), Default(None)
   *  @param frlprocessdate Database column FRLPROCESSDATE SqlType(DATE)
   *  @param frlfilebackuppath Database column FRLFILEBACKUPPATH SqlType(VARCHAR), Length(512,true), Default(None)
   *  @param frllogfilepath Database column FRLLOGFILEPATH SqlType(VARCHAR), Length(512,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcfrlRow(id: Long, frlrtarfnum: Option[Long] = None, frlfilepath: String, frlreversalrfnum: Option[Long] = None, frlprocessdate: java.sql.Date, frlfilebackuppath: Option[String] = None, frllogfilepath: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcfrlRowWrapper(id: Option[Long], frlrtarfnum: Option[Long] = None, frlfilepath: String, frlreversalrfnum: Option[Long] = None, frlprocessdate: java.sql.Date, frlfilebackuppath: Option[String] = None, frllogfilepath: Option[String] = None) {
    def get(userName: String): FcfrlRow = {
      FcfrlRow(this.id.getOrElse(0), this.frlrtarfnum, this.frlfilepath, this.frlreversalrfnum, this.frlprocessdate, this.frlfilebackuppath, this.frllogfilepath, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcfrlRow objects using plain SQL queries */
  implicit def GetResultFcfrlRow(implicit e0: GR[Long], e1: GR[Option[Long]], e2: GR[String], e3: GR[java.sql.Date], e4: GR[Option[String]], e5: GR[Option[java.sql.Timestamp]], e6: GR[java.sql.Timestamp]): GR[FcfrlRow] = GR{
    prs => import prs._
    FcfrlRow.tupled((<<[Long], <<?[Long], <<[String], <<?[Long], <<[java.sql.Date], <<?[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCFRL. Objects of this class serve as prototypes for rows in queries. */
  class Fcfrl(_tableTag: Tag) extends BaseTable[FcfrlRow](_tableTag, "FCFRL") {
    def * = (id, frlrtarfnum, frlfilepath, frlreversalrfnum, frlprocessdate, frlfilebackuppath, frllogfilepath, createdate, modifydate, createdby, lastmodifiedby) <> (FcfrlRow.tupled, FcfrlRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), frlrtarfnum, Rep.Some(frlfilepath), frlreversalrfnum, Rep.Some(frlprocessdate), frlfilebackuppath, frllogfilepath, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcfrlRow.tupled((_1.get, _2, _3.get, _4, _5.get, _6, _7, _8, _9.get, _10.get, _11.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column FRLRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("FRLRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column FRLRTARFNUM SqlType(BIGINT), Default(None) */
    val frlrtarfnum: Rep[Option[Long]] = column[Option[Long]]("FRLRTARFNUM", O.Default(None))
    /** Database column FRLFILEPATH SqlType(VARCHAR), Length(512,true) */
    val frlfilepath: Rep[String] = column[String]("FRLFILEPATH", O.Length(512,varying=true))
    /** Database column FRLREVERSALRFNUM SqlType(BIGINT), Default(None) */
    val frlreversalrfnum: Rep[Option[Long]] = column[Option[Long]]("FRLREVERSALRFNUM", O.Default(None))
    /** Database column FRLPROCESSDATE SqlType(DATE) */
    val frlprocessdate: Rep[java.sql.Date] = column[java.sql.Date]("FRLPROCESSDATE")
    /** Database column FRLFILEBACKUPPATH SqlType(VARCHAR), Length(512,true), Default(None) */
    val frlfilebackuppath: Rep[Option[String]] = column[Option[String]]("FRLFILEBACKUPPATH", O.Length(512,varying=true), O.Default(None))
    /** Database column FRLLOGFILEPATH SqlType(VARCHAR), Length(512,true), Default(None) */
    val frllogfilepath: Rep[Option[String]] = column[Option[String]]("FRLLOGFILEPATH", O.Length(512,varying=true), O.Default(None))





    /** Foreign key referencing Fcfrl (database name FK_FCFRL_FCFRL) */
    lazy val fcfrlFk = foreignKey("FK_FCFRL_FCFRL", frlreversalrfnum, Fcfrl)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcrta (database name FK_FCFRL_FCRTA) */
    lazy val fcrtaFk = foreignKey("FK_FCFRL_FCRTA", frlrtarfnum, Fcrta)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)

    /** Uniqueness Index over (frlfilepath) (database name FRLFILEPATH_UNIQUE) */
    val index1 = index("FRLFILEPATH_UNIQUE", frlfilepath, unique=true)
  }
  /** Collection-like TableQuery object for table Fcfrl */
  lazy val Fcfrl = new TableQuery(tag => new Fcfrl(tag))
   ...
   *  @param imtisfallbacktobse Database column IMTISFALLBACKTOBSE SqlType(CHAR), Length(2,false), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcimtRow(id: Long, imtintgratname: String, imtintgratactive: String, imtintgratdescrp: Option[String] = None, imtisfallbacktobse: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcimtRowWrapper(id: Option[Long], imtintgratname: String, imtintgratactive: String, imtintgratdescrp: Option[String] = None, imtisfallbacktobse: Option[String] = None) {
    def get(userName: String): FcimtRow = {
      FcimtRow(this.id.getOrElse(0), this.imtintgratname, this.imtintgratactive, this.imtintgratdescrp, this.imtisfallbacktobse, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  ...
  implicit def GetResultFcimtRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp]): GR[FcimtRow] = GR{
    prs => import prs._
    FcimtRow.tupled((<<[Long], <<[String], <<[String], <<?[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcimt(_tableTag: Tag) extends BaseTable[FcimtRow](_tableTag, "FCIMT") {
    def * = (id, imtintgratname, imtintgratactive, imtintgratdescrp, imtisfallbacktobse, createdate, modifydate, createdby, lastmodifiedby) <> (FcimtRow.tupled, FcimtRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(imtintgratname), Rep.Some(imtintgratactive), imtintgratdescrp, imtisfallbacktobse, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcimtRow.tupled((_1.get, _2.get, _3.get, _4, _5, _6, _7.get, _8.get, _9.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column IMTISFALLBACKTOBSE SqlType(CHAR), Length(2,false), Default(None) */
    val imtisfallbacktobse: Rep[Option[String]] = column[Option[String]]("IMTISFALLBACKTOBSE", O.Length(2,varying=false), O.Default(None))
  }
  ...
  /** Entity class storing rows of table Fckcl
   *  @param kclrfnum Database column KCLRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param kclpanno Database column KCLPANNO SqlType(CHAR), Length(10,false)
   *  @param kclapi Database column KCLAPI SqlType(CHAR), Length(10,false), Default(None)
   *  @param kclexternalid1 Database column KCLEXTERNALID1 SqlType(VARCHAR), Length(16,true), Default(None)
   *  @param kclexternalid2 Database column KCLEXTERNALID2 SqlType(VARCHAR), Length(16,true), Default(None)
   *  @param kcllastresponse Database column KCLLASTRESPONSE SqlType(VARCHAR), Length(32,true), Default(None)
   *  @param kclrequesttime Database column KCLREQUESTTIME SqlType(TIMESTAMP), Default(None)
   *  @param kclnoofattempts Database column KCLNOOFATTEMPTS SqlType(INT)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FckclRow(id: Long, kclpanno: String, kclapi: Option[String] = None, kclexternalid1: Option[String] = None, kclexternalid2: Option[String] = None, kcllastresponse: Option[String] = None, kclrequesttime: Option[java.sql.Timestamp] = None, kclnoofattempts: Int, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FckclRowWrapper(id: Option[Long], kclpanno: String, kclapi: Option[String] = None, kclexternalid1: Option[String] = None, kclexternalid2: Option[String] = None, kcllastresponse: Option[String] = None, kclrequesttime: Option[java.sql.Timestamp] = None, kclnoofattempts: Int) {
    def get(userName: String): FckclRow = {
      FckclRow(this.id.getOrElse(0), this.kclpanno, this.kclapi, this.kclexternalid1, this.kclexternalid2, this.kcllastresponse, this.kclrequesttime, this.kclnoofattempts, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FckclRow objects using plain SQL queries */
  implicit def GetResultFckclRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[java.sql.Timestamp]], e4: GR[Int], e5: GR[java.sql.Timestamp]): GR[FckclRow] = GR{
    prs => import prs._
    FckclRow.tupled((<<[Long], <<[String], <<?[String], <<?[String], <<?[String], <<?[String], <<?[java.sql.Timestamp], <<[Int], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCKCL. Objects of this class serve as prototypes for rows in queries. */
  class Fckcl(_tableTag: Tag) extends BaseTable[FckclRow](_tableTag, "FCKCL") {
    def * = (id, kclpanno, kclapi, kclexternalid1, kclexternalid2, kcllastresponse, kclrequesttime, kclnoofattempts, createdate, modifydate, createdby, lastmodifiedby) <> (FckclRow.tupled, FckclRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(kclpanno), kclapi, kclexternalid1, kclexternalid2, kcllastresponse, kclrequesttime, Rep.Some(kclnoofattempts), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FckclRow.tupled((_1.get, _2.get, _3, _4, _5, _6, _7, _8.get, _9, _10.get, _11.get, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column KCLRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("KCLRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column KCLPANNO SqlType(CHAR), Length(10,false) */
    val kclpanno: Rep[String] = column[String]("KCLPANNO", O.Length(10,varying=false))
    /** Database column KCLAPI SqlType(CHAR), Length(10,false), Default(None) */
    val kclapi: Rep[Option[String]] = column[Option[String]]("KCLAPI", O.Length(10,varying=false), O.Default(None))
    /** Database column KCLEXTERNALID1 SqlType(VARCHAR), Length(16,true), Default(None) */
    val kclexternalid1: Rep[Option[String]] = column[Option[String]]("KCLEXTERNALID1", O.Length(16,varying=true), O.Default(None))
    /** Database column KCLEXTERNALID2 SqlType(VARCHAR), Length(16,true), Default(None) */
    val kclexternalid2: Rep[Option[String]] = column[Option[String]]("KCLEXTERNALID2", O.Length(16,varying=true), O.Default(None))
    /** Database column KCLLASTRESPONSE SqlType(VARCHAR), Length(32,true), Default(None) */
    val kcllastresponse: Rep[Option[String]] = column[Option[String]]("KCLLASTRESPONSE", O.Length(32,varying=true), O.Default(None))
    /** Database column KCLREQUESTTIME SqlType(TIMESTAMP), Default(None) */
    val kclrequesttime: Rep[Option[java.sql.Timestamp]] = column[Option[java.sql.Timestamp]]("KCLREQUESTTIME", O.Default(None))
    /** Database column KCLNOOFATTEMPTS SqlType(INT) */
    val kclnoofattempts: Rep[Int] = column[Int]("KCLNOOFATTEMPTS")





    /** Uniqueness Index over (kclpanno) (database name UNQ_KCL_PANNO) */
    val index1 = index("UNQ_KCL_PANNO", kclpanno, unique=true)
  }
  /** Collection-like TableQuery object for table Fckcl */
  lazy val Fckcl = new TableQuery(tag => new Fckcl(tag))
  ...
  /** Entity class storing rows of table Fcmer
   *  @param merrfnum Database column MERRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param merfromsoptrfnum Database column MERFROMSOPTRFNUM SqlType(BIGINT)
   *  @param mertosoptrfnum Database column MERTOSOPTRFNUM SqlType(BIGINT)
   *  @param merstartdate Database column MERSTARTDATE SqlType(DATE)
   *  @param merfromdate Database column MERFROMDATE SqlType(DATE)
   *  @param merremark Database column MERREMARK SqlType(VARCHAR), Length(128,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcmerRow(id: Long, merfromsoptrfnum: Long, mertosoptrfnum: Long, merstartdate: java.sql.Date, merfromdate: java.sql.Date, merremark: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcmerRowWrapper(id: Option[Long], merfromsoptrfnum: Long, mertosoptrfnum: Long, merstartdate: java.sql.Date, merfromdate: java.sql.Date, merremark: Option[String] = None) {
    def get(userName: String): FcmerRow = {
      FcmerRow(this.id.getOrElse(0), this.merfromsoptrfnum, this.mertosoptrfnum, this.merstartdate, this.merfromdate, this.merremark, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcmerRow objects using plain SQL queries */
  implicit def GetResultFcmerRow(implicit e0: GR[Long], e1: GR[java.sql.Date], e2: GR[Option[String]], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp], e5: GR[String]): GR[FcmerRow] = GR{
    prs => import prs._
    FcmerRow.tupled((<<[Long], <<[Long], <<[Long], <<[java.sql.Date], <<[java.sql.Date], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCMER. Objects of this class serve as prototypes for rows in queries. */
  class Fcmer(_tableTag: Tag) extends BaseTable[FcmerRow](_tableTag, "FCMER") {
    def * = (id, merfromsoptrfnum, mertosoptrfnum, merstartdate, merfromdate, merremark, createdate, modifydate, createdby, lastmodifiedby) <> (FcmerRow.tupled, FcmerRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(merfromsoptrfnum), Rep.Some(mertosoptrfnum), Rep.Some(merstartdate), Rep.Some(merfromdate), merremark, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcmerRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7, _8.get, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column MERRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("MERRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column MERFROMSOPTRFNUM SqlType(BIGINT) */
    val merfromsoptrfnum: Rep[Long] = column[Long]("MERFROMSOPTRFNUM")
    /** Database column MERTOSOPTRFNUM SqlType(BIGINT) */
    val mertosoptrfnum: Rep[Long] = column[Long]("MERTOSOPTRFNUM")
    /** Database column MERSTARTDATE SqlType(DATE) */
    val merstartdate: Rep[java.sql.Date] = column[java.sql.Date]("MERSTARTDATE")
    /** Database column MERFROMDATE SqlType(DATE) */
    val merfromdate: Rep[java.sql.Date] = column[java.sql.Date]("MERFROMDATE")
    /** Database column MERREMARK SqlType(VARCHAR), Length(128,true), Default(None) */
    val merremark: Rep[Option[String]] = column[Option[String]]("MERREMARK", O.Length(128,varying=true), O.Default(None))





    /** Foreign key referencing Fcsopt (database name FK_FCMER_FCSOPT) */
    lazy val fcsoptFk1 = foreignKey("FK_FCMER_FCSOPT", merfromsoptrfnum, Fcsopt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcsopt (database name FK_FCMER_FCSOPT_02) */
    lazy val fcsoptFk2 = foreignKey("FK_FCMER_FCSOPT_02", mertosoptrfnum, Fcsopt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)

    /** Uniqueness Index over (merfromsoptrfnum,mertosoptrfnum) (database name MER_FROMSOPT_TOSOPT) */
    val index1 = index("MER_FROMSOPT_TOSOPT", (merfromsoptrfnum, mertosoptrfnum), unique=true)
  }
  /** Collection-like TableQuery object for table Fcmer */
  lazy val Fcmer = new TableQuery(tag => new Fcmer(tag))
  ...
  /** Entity class storing rows of table Fcooa
   *  @param ooarfnum Database column OOARFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param ooaotptrfnum Database column OOAOTPTRFNUM SqlType(BIGINT)
   *  @param ooaomtrfnum Database column OOAOMTRFNUM SqlType(BIGINT)
   *  @param ooaubdrfnum Database column OOAUBDRFNUM SqlType(BIGINT), Default(None)
   *  @param ooapurpose Database column OOAPURPOSE SqlType(CHAR), Length(32,false), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcooaRow(id: Long, ooaotptrfnum: Long, ooaomtrfnum: Long, ooaubdrfnum: Option[Long] = None, ooapurpose: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcooaRowWrapper(id: Option[Long], ooaotptrfnum: Long, ooaomtrfnum: Long, ooaubdrfnum: Option[Long] = None, ooapurpose: Option[String] = None) {
    def get(userName: String): FcooaRow = {
      FcooaRow(this.id.getOrElse(0), this.ooaotptrfnum, this.ooaomtrfnum, this.ooaubdrfnum, this.ooapurpose, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcooaRow objects using plain SQL queries */
  implicit def GetResultFcooaRow(implicit e0: GR[Long], e1: GR[Option[Long]], e2: GR[Option[String]], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp], e5: GR[String]): GR[FcooaRow] = GR{
    prs => import prs._
    FcooaRow.tupled((<<[Long], <<[Long], <<[Long], <<?[Long], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCOOA. Objects of this class serve as prototypes for rows in queries. */
  class Fcooa(_tableTag: Tag) extends BaseTable[FcooaRow](_tableTag, "FCOOA") {
    def * = (id, ooaotptrfnum, ooaomtrfnum, ooaubdrfnum, ooapurpose, createdate, modifydate, createdby, lastmodifiedby) <> (FcooaRow.tupled, FcooaRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(ooaotptrfnum), Rep.Some(ooaomtrfnum), ooaubdrfnum, ooapurpose, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcooaRow.tupled((_1.get, _2.get, _3.get, _4, _5, _6, _7.get, _8.get, _9.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column OOARFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("OOARFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column OOAOTPTRFNUM SqlType(BIGINT) */
    val ooaotptrfnum: Rep[Long] = column[Long]("OOAOTPTRFNUM")
    /** Database column OOAOMTRFNUM SqlType(BIGINT) */
    val ooaomtrfnum: Rep[Long] = column[Long]("OOAOMTRFNUM")
    /** Database column OOAUBDRFNUM SqlType(BIGINT), Default(None) */
    val ooaubdrfnum: Rep[Option[Long]] = column[Option[Long]]("OOAUBDRFNUM", O.Default(None))
    /** Database column OOAPURPOSE SqlType(CHAR), Length(32,false), Default(None) */
    val ooapurpose: Rep[Option[String]] = column[Option[String]]("OOAPURPOSE", O.Length(32,varying=false), O.Default(None))





    /** Foreign key referencing Fcomt (database name FK_FCOOA_FCOMT) */
    lazy val fcomtFk = foreignKey("FK_FCOOA_FCOMT", ooaomtrfnum, Fcomt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcotpt (database name FK_FCOOA_FCOTPT) */
    lazy val fcotptFk = foreignKey("FK_FCOOA_FCOTPT", ooaotptrfnum, Fcotpt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcubd (database name FK_FCOOA_FCUBD) */
    lazy val fcubdFk = foreignKey("FK_FCOOA_FCUBD", ooaubdrfnum, Fcubd)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fcooa */
  lazy val Fcooa = new TableQuery(tag => new Fcooa(tag))
   ...
   *  @param ostmtostates Database column OSTMTOSTATES SqlType(VARCHAR), Length(128,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcostmRow(id: Long, ostmname: String, ostmactive: String, ostmdescrip: Option[String] = None, ostmdisplayname: String, ostmtooltip: Option[String] = None, ostmtostates: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcostmRowWrapper(id: Option[Long], ostmname: String, ostmactive: String, ostmdescrip: Option[String] = None, ostmdisplayname: String, ostmtooltip: Option[String] = None, ostmtostates: Option[String] = None) {
    def get(userName: String): FcostmRow = {
      FcostmRow(this.id.getOrElse(0), this.ostmname, this.ostmactive, this.ostmdescrip, this.ostmdisplayname, this.ostmtooltip, this.ostmtostates, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  ...
  implicit def GetResultFcostmRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp]): GR[FcostmRow] = GR{
    prs => import prs._
    FcostmRow.tupled((<<[Long], <<[String], <<[String], <<?[String], <<[String], <<?[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcostm(_tableTag: Tag) extends BaseTable[FcostmRow](_tableTag, "FCOSTM") {
    def * = (id, ostmname, ostmactive, ostmdescrip, ostmdisplayname, ostmtooltip, ostmtostates, createdate, modifydate, createdby, lastmodifiedby) <> (FcostmRow.tupled, FcostmRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(ostmname), Rep.Some(ostmactive), ostmdescrip, Rep.Some(ostmdisplayname), ostmtooltip, ostmtostates, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcostmRow.tupled((_1.get, _2.get, _3.get, _4, _5.get, _6, _7, _8, _9.get, _10.get, _11.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column OSTMTOSTATES SqlType(VARCHAR), Length(128,true), Default(None) */
    val ostmtostates: Rep[Option[String]] = column[Option[String]]("OSTMTOSTATES", O.Length(128,varying=true), O.Default(None))
  }
   ...
   *  @param otptreqtime Database column OTPTREQTIME SqlType(TIMESTAMP), Default(None)
   *  @param otptvaliditytime Database column OTPTVALIDITYTIME SqlType(TIMESTAMP), Default(None)
   *  @param otptstatus Database column OTPTSTATUS SqlType(CHAR), Length(10,false), Default(None)
   *  @param otptmessageid Database column OTPTMESSAGEID SqlType(CHAR), Length(64,false), Default(None)
   *  @param otptgatewayid Database column OTPTGATEWAYID SqlType(CHAR), Length(2,false)
   *  @param otptisvalid Database column OTPTISVALID SqlType(CHAR), Length(2,false)
   *  @param otptipaddress Database column OTPTIPADDRESS SqlType(VARCHAR), Length(64,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcotptRow(id: Long, otptmobileno: String, otptotp: String, otptreqtime: Option[java.sql.Timestamp] = None, otptvaliditytime: Option[java.sql.Timestamp] = None, otptstatus: Option[String] = None, otptmessageid: Option[String] = None, otptgatewayid: String, otptisvalid: String, otptipaddress: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcotptRowWrapper(id: Option[Long], otptmobileno: String, otptotp: String, otptreqtime: Option[java.sql.Timestamp] = None, otptvaliditytime: Option[java.sql.Timestamp] = None, otptstatus: Option[String] = None, otptmessageid: Option[String] = None, otptgatewayid: String, otptisvalid: String, otptipaddress: Option[String] = None) {
    def get(userName: String): FcotptRow = {
      FcotptRow(this.id.getOrElse(0), this.otptmobileno, this.otptotp, this.otptreqtime, this.otptvaliditytime, this.otptstatus, this.otptmessageid, this.otptgatewayid, this.otptisvalid, this.otptipaddress, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  ...
  implicit def GetResultFcotptRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[java.sql.Timestamp]], e3: GR[Option[String]], e4: GR[java.sql.Timestamp]): GR[FcotptRow] = GR{
    prs => import prs._
    FcotptRow.tupled((<<[Long], <<[String], <<[String], <<?[java.sql.Timestamp], <<?[java.sql.Timestamp], <<?[String], <<?[String], <<[String], <<[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcotpt(_tableTag: Tag) extends BaseTable[FcotptRow](_tableTag, "FCOTPT") {
    def * = (id, otptmobileno, otptotp, otptreqtime, otptvaliditytime, otptstatus, otptmessageid, otptgatewayid, otptisvalid, otptipaddress, createdate, modifydate, createdby, lastmodifiedby) <> (FcotptRow.tupled, FcotptRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(otptmobileno), Rep.Some(otptotp), otptreqtime, otptvaliditytime, otptstatus, otptmessageid, Rep.Some(otptgatewayid), Rep.Some(otptisvalid), otptipaddress, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcotptRow.tupled((_1.get, _2.get, _3.get, _4, _5, _6, _7, _8.get, _9.get, _10, _11, _12.get, _13.get, _14.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column OTPTREQTIME SqlType(TIMESTAMP), Default(None) */
    val otptreqtime: Rep[Option[java.sql.Timestamp]] = column[Option[java.sql.Timestamp]]("OTPTREQTIME", O.Default(None))
    /** Database column OTPTVALIDITYTIME SqlType(TIMESTAMP), Default(None) */
    val otptvaliditytime: Rep[Option[java.sql.Timestamp]] = column[Option[java.sql.Timestamp]]("OTPTVALIDITYTIME", O.Default(None))
    /** Database column OTPTSTATUS SqlType(CHAR), Length(10,false), Default(None) */
    val otptstatus: Rep[Option[String]] = column[Option[String]]("OTPTSTATUS", O.Length(10,varying=false), O.Default(None))
    /** Database column OTPTMESSAGEID SqlType(CHAR), Length(64,false), Default(None) */
    val otptmessageid: Rep[Option[String]] = column[Option[String]]("OTPTMESSAGEID", O.Length(64,varying=false), O.Default(None))
    /** Database column OTPTGATEWAYID SqlType(CHAR), Length(2,false) */
    val otptgatewayid: Rep[String] = column[String]("OTPTGATEWAYID", O.Length(2,varying=false))
    /** Database column OTPTISVALID SqlType(CHAR), Length(2,false) */
    val otptisvalid: Rep[String] = column[String]("OTPTISVALID", O.Length(2,varying=false))
    /** Database column OTPTIPADDRESS SqlType(VARCHAR), Length(64,true), Default(None) */
    val otptipaddress: Rep[Option[String]] = column[Option[String]]("OTPTIPADDRESS", O.Length(64,varying=true), O.Default(None))
  }
  ...
  /** Entity class storing rows of table Fcrdl
   *  @param rdlrfnum Database column RDLRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param rdlfrlrfnum Database column RDLFRLRFNUM SqlType(BIGINT)
   *  @param rdlrtarfnum Database column RDLRTARFNUM SqlType(BIGINT), Default(None)
   *  @param rdlrtatxnno Database column RDLRTATXNNO SqlType(VARCHAR), Length(128,true)
   *  @param rdlorderref Database column RDLORDERREF SqlType(VARCHAR), Length(128,true), Default(None)
   *  @param rdlrtasystematicref Database column RDLRTASYSTEMATICREF SqlType(VARCHAR), Length(128,true), Default(None)
   *  @param rdlstatus Database column RDLSTATUS SqlType(VARCHAR), Length(10,true)
   *  @param rdlremark Database column RDLREMARK SqlType(VARCHAR), Length(512,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcrdlRow(id: Long, rdlfrlrfnum: Long, rdlrtarfnum: Option[Long] = None, rdlrtatxnno: String, rdlorderref: Option[String] = None, rdlrtasystematicref: Option[String] = None, rdlstatus: String, rdlremark: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcrdlRowWrapper(id: Option[Long], rdlfrlrfnum: Long, rdlrtarfnum: Option[Long] = None, rdlrtatxnno: String, rdlorderref: Option[String] = None, rdlrtasystematicref: Option[String] = None, rdlstatus: String, rdlremark: Option[String] = None) {
    def get(userName: String): FcrdlRow = {
      FcrdlRow(this.id.getOrElse(0), this.rdlfrlrfnum, this.rdlrtarfnum, this.rdlrtatxnno, this.rdlorderref, this.rdlrtasystematicref, this.rdlstatus, this.rdlremark, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcrdlRow objects using plain SQL queries */
  implicit def GetResultFcrdlRow(implicit e0: GR[Long], e1: GR[Option[Long]], e2: GR[String], e3: GR[Option[String]], e4: GR[Option[java.sql.Timestamp]], e5: GR[java.sql.Timestamp]): GR[FcrdlRow] = GR{
    prs => import prs._
    FcrdlRow.tupled((<<[Long], <<[Long], <<?[Long], <<[String], <<?[String], <<?[String], <<[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCRDL. Objects of this class serve as prototypes for rows in queries. */
  class Fcrdl(_tableTag: Tag) extends BaseTable[FcrdlRow](_tableTag, "FCRDL") {
    def * = (id, rdlfrlrfnum, rdlrtarfnum, rdlrtatxnno, rdlorderref, rdlrtasystematicref, rdlstatus, rdlremark, createdate, modifydate, createdby, lastmodifiedby) <> (FcrdlRow.tupled, FcrdlRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(rdlfrlrfnum), rdlrtarfnum, Rep.Some(rdlrtatxnno), rdlorderref, rdlrtasystematicref, Rep.Some(rdlstatus), rdlremark, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcrdlRow.tupled((_1.get, _2.get, _3, _4.get, _5, _6, _7.get, _8, _9, _10.get, _11.get, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column RDLRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("RDLRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column RDLFRLRFNUM SqlType(BIGINT) */
    val rdlfrlrfnum: Rep[Long] = column[Long]("RDLFRLRFNUM")
    /** Database column RDLRTARFNUM SqlType(BIGINT), Default(None) */
    val rdlrtarfnum: Rep[Option[Long]] = column[Option[Long]]("RDLRTARFNUM", O.Default(None))
    /** Database column RDLRTATXNNO SqlType(VARCHAR), Length(128,true) */
    val rdlrtatxnno: Rep[String] = column[String]("RDLRTATXNNO", O.Length(128,varying=true))
    /** Database column RDLORDERREF SqlType(VARCHAR), Length(128,true), Default(None) */
    val rdlorderref: Rep[Option[String]] = column[Option[String]]("RDLORDERREF", O.Length(128,varying=true), O.Default(None))
    /** Database column RDLRTASYSTEMATICREF SqlType(VARCHAR), Length(128,true), Default(None) */
    val rdlrtasystematicref: Rep[Option[String]] = column[Option[String]]("RDLRTASYSTEMATICREF", O.Length(128,varying=true), O.Default(None))
    /** Database column RDLSTATUS SqlType(VARCHAR), Length(10,true) */
    val rdlstatus: Rep[String] = column[String]("RDLSTATUS", O.Length(10,varying=true))
    /** Database column RDLREMARK SqlType(VARCHAR), Length(512,true), Default(None) */
    val rdlremark: Rep[Option[String]] = column[Option[String]]("RDLREMARK", O.Length(512,varying=true), O.Default(None))





    /** Foreign key referencing Fcfrl (database name FK_FCRDL_FCFRL) */
    lazy val fcfrlFk = foreignKey("FK_FCRDL_FCFRL", rdlfrlrfnum, Fcfrl)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcrta (database name FK_FCRDL_FCRTA) */
    lazy val fcrtaFk = foreignKey("FK_FCRDL_FCRTA", rdlrtarfnum, Fcrta)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fcrdl */
  lazy val Fcrdl = new TableQuery(tag => new Fcrdl(tag))
  ...
  /** Entity class storing rows of table Fcrpa
   *  @param rparfnum Database column RPARFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param rpasoptrfnum Database column RPASOPTRFNUM SqlType(BIGINT)
   *  @param rpaminpuramount Database column RPAMINPURAMOUNT SqlType(DOUBLE), Default(None)
   *  @param rpamaxpuramount Database column RPAMAXPURAMOUNT SqlType(DOUBLE), Default(None)
   *  @param rpapuramtmultiplier Database column RPAPURAMTMULTIPLIER SqlType(DOUBLE), Default(None)
   *  @param rpaminredamount Database column RPAMINREDAMOUNT SqlType(DOUBLE), Default(None)
   *  @param rpamaxredamount Database column RPAMAXREDAMOUNT SqlType(DOUBLE), Default(None)
   *  @param rparedamtmultiplier Database column RPAREDAMTMULTIPLIER SqlType(DOUBLE), Default(None)
   *  @param rpaminredunit Database column RPAMINREDUNIT SqlType(DOUBLE), Default(None)
   *  @param rpamaxredunit Database column RPAMAXREDUNIT SqlType(DOUBLE), Default(None)
   *  @param rparedunitmultiplier Database column RPAREDUNITMULTIPLIER SqlType(DOUBLE), Default(None)
   *  @param rpaminnfoamount Database column RPAMINNFOAMOUNT SqlType(DOUBLE), Default(None)
   *  @param rpamaxnfoamount Database column RPAMAXNFOAMOUNT SqlType(DOUBLE), Default(None)
   *  @param rpaminaddinvestamt Database column RPAMINADDINVESTAMT SqlType(DOUBLE), Default(None)
   *  @param rpaminaddinvestmultiplier Database column RPAMINADDINVESTMULTIPLIER SqlType(DOUBLE), Default(None)
   *  @param rpaispurchaseallowed Database column RPAISPURCHASEALLOWED SqlType(CHAR), Length(2,false)
   *  @param rpaisredemptionallowed Database column RPAISREDEMPTIONALLOWED SqlType(CHAR), Length(2,false)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcrpaRow(id: Long, rpasoptrfnum: Long, rpaminpuramount: Option[Double] = None, rpamaxpuramount: Option[Double] = None, rpapuramtmultiplier: Option[Double] = None, rpaminredamount: Option[Double] = None, rpamaxredamount: Option[Double] = None, rparedamtmultiplier: Option[Double] = None, rpaminredunit: Option[Double] = None, rpamaxredunit: Option[Double] = None, rparedunitmultiplier: Option[Double] = None, rpaminnfoamount: Option[Double] = None, rpamaxnfoamount: Option[Double] = None, rpaminaddinvestamt: Option[Double] = None, rpaminaddinvestmultiplier: Option[Double] = None, rpaispurchaseallowed: String, rpaisredemptionallowed: String, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcrpaRowWrapper(id: Option[Long], rpasoptrfnum: Long, rpaminpuramount: Option[Double] = None, rpamaxpuramount: Option[Double] = None, rpapuramtmultiplier: Option[Double] = None, rpaminredamount: Option[Double] = None, rpamaxredamount: Option[Double] = None, rparedamtmultiplier: Option[Double] = None, rpaminredunit: Option[Double] = None, rpamaxredunit: Option[Double] = None, rparedunitmultiplier: Option[Double] = None, rpaminnfoamount: Option[Double] = None, rpamaxnfoamount: Option[Double] = None, rpaminaddinvestamt: Option[Double] = None, rpaminaddinvestmultiplier: Option[Double] = None, rpaispurchaseallowed: String, rpaisredemptionallowed: String) {
    def get(userName: String): FcrpaRow = {
      FcrpaRow(this.id.getOrElse(0), this.rpasoptrfnum, this.rpaminpuramount, this.rpamaxpuramount, this.rpapuramtmultiplier, this.rpaminredamount, this.rpamaxredamount, this.rparedamtmultiplier, this.rpaminredunit, this.rpamaxredunit, this.rparedunitmultiplier, this.rpaminnfoamount, this.rpamaxnfoamount, this.rpaminaddinvestamt, this.rpaminaddinvestmultiplier, this.rpaispurchaseallowed, this.rpaisredemptionallowed, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcrpaRow objects using plain SQL queries */
  implicit def GetResultFcrpaRow(implicit e0: GR[Long], e1: GR[Option[Double]], e2: GR[String], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp]): GR[FcrpaRow] = GR{
    prs => import prs._
    FcrpaRow.tupled((<<[Long], <<[Long], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<[String], <<[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCRPA. Objects of this class serve as prototypes for rows in queries. */
  class Fcrpa(_tableTag: Tag) extends BaseTable[FcrpaRow](_tableTag, "FCRPA") {
    def * = (id, rpasoptrfnum, rpaminpuramount, rpamaxpuramount, rpapuramtmultiplier, rpaminredamount, rpamaxredamount, rparedamtmultiplier, rpaminredunit, rpamaxredunit, rparedunitmultiplier, rpaminnfoamount, rpamaxnfoamount, rpaminaddinvestamt, rpaminaddinvestmultiplier, rpaispurchaseallowed, rpaisredemptionallowed, createdate, modifydate, createdby, lastmodifiedby) <> (FcrpaRow.tupled, FcrpaRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(rpasoptrfnum), rpaminpuramount, rpamaxpuramount, rpapuramtmultiplier, rpaminredamount, rpamaxredamount, rparedamtmultiplier, rpaminredunit, rpamaxredunit, rparedunitmultiplier, rpaminnfoamount, rpamaxnfoamount, rpaminaddinvestamt, rpaminaddinvestmultiplier, Rep.Some(rpaispurchaseallowed), Rep.Some(rpaisredemptionallowed), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcrpaRow.tupled((_1.get, _2.get, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16.get, _17.get, _18, _19.get, _20.get, _21.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column RPARFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("RPARFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column RPASOPTRFNUM SqlType(BIGINT) */
    val rpasoptrfnum: Rep[Long] = column[Long]("RPASOPTRFNUM")
    /** Database column RPAMINPURAMOUNT SqlType(DOUBLE), Default(None) */
    val rpaminpuramount: Rep[Option[Double]] = column[Option[Double]]("RPAMINPURAMOUNT", O.Default(None))
    /** Database column RPAMAXPURAMOUNT SqlType(DOUBLE), Default(None) */
    val rpamaxpuramount: Rep[Option[Double]] = column[Option[Double]]("RPAMAXPURAMOUNT", O.Default(None))
    /** Database column RPAPURAMTMULTIPLIER SqlType(DOUBLE), Default(None) */
    val rpapuramtmultiplier: Rep[Option[Double]] = column[Option[Double]]("RPAPURAMTMULTIPLIER", O.Default(None))
    /** Database column RPAMINREDAMOUNT SqlType(DOUBLE), Default(None) */
    val rpaminredamount: Rep[Option[Double]] = column[Option[Double]]("RPAMINREDAMOUNT", O.Default(None))
    /** Database column RPAMAXREDAMOUNT SqlType(DOUBLE), Default(None) */
    val rpamaxredamount: Rep[Option[Double]] = column[Option[Double]]("RPAMAXREDAMOUNT", O.Default(None))
    /** Database column RPAREDAMTMULTIPLIER SqlType(DOUBLE), Default(None) */
    val rparedamtmultiplier: Rep[Option[Double]] = column[Option[Double]]("RPAREDAMTMULTIPLIER", O.Default(None))
    /** Database column RPAMINREDUNIT SqlType(DOUBLE), Default(None) */
    val rpaminredunit: Rep[Option[Double]] = column[Option[Double]]("RPAMINREDUNIT", O.Default(None))
    /** Database column RPAMAXREDUNIT SqlType(DOUBLE), Default(None) */
    val rpamaxredunit: Rep[Option[Double]] = column[Option[Double]]("RPAMAXREDUNIT", O.Default(None))
    /** Database column RPAREDUNITMULTIPLIER SqlType(DOUBLE), Default(None) */
    val rparedunitmultiplier: Rep[Option[Double]] = column[Option[Double]]("RPAREDUNITMULTIPLIER", O.Default(None))
    /** Database column RPAMINNFOAMOUNT SqlType(DOUBLE), Default(None) */
    val rpaminnfoamount: Rep[Option[Double]] = column[Option[Double]]("RPAMINNFOAMOUNT", O.Default(None))
    /** Database column RPAMAXNFOAMOUNT SqlType(DOUBLE), Default(None) */
    val rpamaxnfoamount: Rep[Option[Double]] = column[Option[Double]]("RPAMAXNFOAMOUNT", O.Default(None))
    /** Database column RPAMINADDINVESTAMT SqlType(DOUBLE), Default(None) */
    val rpaminaddinvestamt: Rep[Option[Double]] = column[Option[Double]]("RPAMINADDINVESTAMT", O.Default(None))
    /** Database column RPAMINADDINVESTMULTIPLIER SqlType(DOUBLE), Default(None) */
    val rpaminaddinvestmultiplier: Rep[Option[Double]] = column[Option[Double]]("RPAMINADDINVESTMULTIPLIER", O.Default(None))
    /** Database column RPAISPURCHASEALLOWED SqlType(CHAR), Length(2,false) */
    val rpaispurchaseallowed: Rep[String] = column[String]("RPAISPURCHASEALLOWED", O.Length(2,varying=false))
    /** Database column RPAISREDEMPTIONALLOWED SqlType(CHAR), Length(2,false) */
    val rpaisredemptionallowed: Rep[String] = column[String]("RPAISREDEMPTIONALLOWED", O.Length(2,varying=false))





    /** Foreign key referencing Fcsopt (database name FK_FCRPA_FCSOPT) */
    lazy val fcsoptFk = foreignKey("FK_FCRPA_FCSOPT", rpasoptrfnum, Fcsopt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fcrpa */
  lazy val Fcrpa = new TableQuery(tag => new Fcrpa(tag))
  ...
  /** Entity class storing rows of table Fcsdt
   *  @param sdtrfnum Database column SDTRFNUM SqlType(BIGINT), PrimaryKey
   *  @param sdtimtrfnum Database column SDTIMTRFNUM SqlType(BIGINT), Default(None)
   *  @param sdtfromtime Database column SDTFROMTIME SqlType(TIMESTAMP), Default(None)
   *  @param sdttotime Database column SDTTOTIME SqlType(TIMESTAMP), Default(None)
   *  @param sdtreason Database column SDTREASON SqlType(VARCHAR), Length(512,true), Default(None)
   *  @param sdtmessage Database column SDTMESSAGE SqlType(VARCHAR), Length(2048,true)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcsdtRow(id: Long, sdtimtrfnum: Option[Long] = None, sdtfromtime: Option[java.sql.Timestamp] = None, sdttotime: Option[java.sql.Timestamp] = None, sdtreason: Option[String] = None, sdtmessage: String, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcsdtRowWrapper(id: Long, sdtimtrfnum: Option[Long] = None, sdtfromtime: Option[java.sql.Timestamp] = None, sdttotime: Option[java.sql.Timestamp] = None, sdtreason: Option[String] = None, sdtmessage: String) {
    def get(userName: String): FcsdtRow = {
      FcsdtRow(this.id, this.sdtimtrfnum, this.sdtfromtime, this.sdttotime, this.sdtreason, this.sdtmessage, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcsdtRow objects using plain SQL queries */
  implicit def GetResultFcsdtRow(implicit e0: GR[Long], e1: GR[Option[Long]], e2: GR[Option[java.sql.Timestamp]], e3: GR[Option[String]], e4: GR[String], e5: GR[java.sql.Timestamp]): GR[FcsdtRow] = GR{
    prs => import prs._
    FcsdtRow.tupled((<<[Long], <<?[Long], <<?[java.sql.Timestamp], <<?[java.sql.Timestamp], <<?[String], <<[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCSDT. Objects of this class serve as prototypes for rows in queries. */
  class Fcsdt(_tableTag: Tag) extends BaseTable[FcsdtRow](_tableTag, "FCSDT") {
    def * = (id, sdtimtrfnum, sdtfromtime, sdttotime, sdtreason, sdtmessage, createdate, modifydate, createdby, lastmodifiedby) <> (FcsdtRow.tupled, FcsdtRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), sdtimtrfnum, sdtfromtime, sdttotime, sdtreason, Rep.Some(sdtmessage), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcsdtRow.tupled((_1.get, _2, _3, _4, _5, _6.get, _7, _8.get, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column SDTRFNUM SqlType(BIGINT), PrimaryKey */
    override val id: Rep[Long] = column[Long]("SDTRFNUM", O.PrimaryKey)
    /** Database column SDTIMTRFNUM SqlType(BIGINT), Default(None) */
    val sdtimtrfnum: Rep[Option[Long]] = column[Option[Long]]("SDTIMTRFNUM", O.Default(None))
    /** Database column SDTFROMTIME SqlType(TIMESTAMP), Default(None) */
    val sdtfromtime: Rep[Option[java.sql.Timestamp]] = column[Option[java.sql.Timestamp]]("SDTFROMTIME", O.Default(None))
    /** Database column SDTTOTIME SqlType(TIMESTAMP), Default(None) */
    val sdttotime: Rep[Option[java.sql.Timestamp]] = column[Option[java.sql.Timestamp]]("SDTTOTIME", O.Default(None))
    /** Database column SDTREASON SqlType(VARCHAR), Length(512,true), Default(None) */
    val sdtreason: Rep[Option[String]] = column[Option[String]]("SDTREASON", O.Length(512,varying=true), O.Default(None))
    /** Database column SDTMESSAGE SqlType(VARCHAR), Length(2048,true) */
    val sdtmessage: Rep[String] = column[String]("SDTMESSAGE", O.Length(2048,varying=true))





    /** Foreign key referencing Fcimt (database name FK_FCSDT_FCIMT) */
    lazy val fcimtFk = foreignKey("FK_FCSDT_FCIMT", sdtimtrfnum, Fcimt)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fcsdt */
  lazy val Fcsdt = new TableQuery(tag => new Fcsdt(tag))
   ...
   *  @param sftsipflag Database column SFTSIPFLAG SqlType(CHAR), Length(2,false), Default(N)
   ...
   *  @param sftlockinperiodflag Database column SFTLOCKINPERIODFLAG SqlType(CHAR), Length(2,false), Default(N)
   ...
   *  @param modifydate 
   *  @param createdate  */
  case class FcsftRow(id: Long, sftsipflag: String = "N", sftstpflag: String, sftswpflag: String, sftlockinperiodflag: String = "N", sftlockinperiodindays: Option[Int] = None, sftterminationdate: Option[java.sql.Date] = None, sftexitloadflag: String, sftswitchflag: String, lastmodifiedby: String, createdby: String, modifydate: java.sql.Timestamp, createdate: Option[java.sql.Timestamp] = None) extends BaseEntity 
  class FcsftRowWrapper(id: Long, sftsipflag: String = "N", sftstpflag: String, sftswpflag: String, sftlockinperiodflag: String = "N", sftlockinperiodindays: Option[Int] = None, sftterminationdate: Option[java.sql.Date] = None, sftexitloadflag: String, sftswitchflag: String) {
    def get(userName: String): FcsftRow = {
      FcsftRow(this.id, this.sftsipflag, this.sftstpflag, this.sftswpflag, this.sftlockinperiodflag, this.sftlockinperiodindays, this.sftterminationdate, this.sftexitloadflag, this.sftswitchflag, userName, userName, DateTimeUtils.getCurrentTimeStamp, Some(DateTimeUtils.getCurrentTimeStamp))
  	}
  }
  /** GetResult implicit for fetching FcsftRow objects using plain SQL queries */
  implicit def GetResultFcsftRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[Int]], e3: GR[Option[java.sql.Date]], e4: GR[java.sql.Timestamp], e5: GR[Option[java.sql.Timestamp]]): GR[FcsftRow] = GR{
    prs => import prs._
    FcsftRow.tupled((<<[Long], <<[String], <<[String], <<[String], <<[String], <<?[Int], <<?[java.sql.Date], <<[String], <<[String], <<[String], <<[String], <<[java.sql.Timestamp], <<?[java.sql.Timestamp]))
  }
  ...
  class Fcsft(_tableTag: Tag) extends BaseTable[FcsftRow](_tableTag, "FCSFT") {
    def * = (id, sftsipflag, sftstpflag, sftswpflag, sftlockinperiodflag, sftlockinperiodindays, sftterminationdate, sftexitloadflag, sftswitchflag, lastmodifiedby, createdby, modifydate, createdate) <> (FcsftRow.tupled, FcsftRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(sftsipflag), Rep.Some(sftstpflag), Rep.Some(sftswpflag), Rep.Some(sftlockinperiodflag), sftlockinperiodindays, sftterminationdate, Rep.Some(sftexitloadflag), Rep.Some(sftswitchflag), Rep.Some(lastmodifiedby), Rep.Some(createdby), Rep.Some(modifydate), createdate).shaped.<>({r=>import r._; _1.map(_=> FcsftRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7, _8.get, _9.get, _10.get, _11.get, _12.get, _13)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column SFTSOPTRFNUM SqlType(BIGINT), PrimaryKey */
    override val id: Rep[Long] = column[Long]("SFTSOPTRFNUM", O.PrimaryKey)
    /** Database column SFTSIPFLAG SqlType(CHAR), Length(2,false), Default(N) */
    val sftsipflag: Rep[String] = column[String]("SFTSIPFLAG", O.Length(2,varying=false), O.Default("N"))
    ...
    /** Database column SFTLOCKINPERIODFLAG SqlType(CHAR), Length(2,false), Default(N) */
    val sftlockinperiodflag: Rep[String] = column[String]("SFTLOCKINPERIODFLAG", O.Length(2,varying=false), O.Default("N"))
   ...
   *  @param siarfnum Database column SIARFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param siasmtrfnum Database column SIASMTRFNUM SqlType(BIGINT)
   *  @param siasoptrfnum Database column SIASOPTRFNUM SqlType(BIGINT)
   ...
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcsiaRow(id: Long, siasmtrfnum: Long, siasoptrfnum: Long, siaimtrfnum: Long, siatxntype: String, siaextfield: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcsiaRowWrapper(id: Option[Long], siasmtrfnum: Long, siasoptrfnum: Long, siaimtrfnum: Long, siatxntype: String, siaextfield: Option[String] = None) {
    def get(userName: String): FcsiaRow = {
      FcsiaRow(this.id.getOrElse(0), this.siasmtrfnum, this.siasoptrfnum, this.siaimtrfnum, this.siatxntype, this.siaextfield, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  ...
  implicit def GetResultFcsiaRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp]): GR[FcsiaRow] = GR{
    prs => import prs._
    FcsiaRow.tupled((<<[Long], <<[Long], <<[Long], <<[Long], <<[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcsia(_tableTag: Tag) extends BaseTable[FcsiaRow](_tableTag, "FCSIA") {
    def * = (id, siasmtrfnum, siasoptrfnum, siaimtrfnum, siatxntype, siaextfield, createdate, modifydate, createdby, lastmodifiedby) <> (FcsiaRow.tupled, FcsiaRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(siasmtrfnum), Rep.Some(siasoptrfnum), Rep.Some(siaimtrfnum), Rep.Some(siatxntype), siaextfield, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcsiaRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7, _8.get, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column SIARFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("SIARFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column SIASMTRFNUM SqlType(BIGINT) */
    val siasmtrfnum: Rep[Long] = column[Long]("SIASMTRFNUM")
    /** Database column SIASOPTRFNUM SqlType(BIGINT) */
    val siasoptrfnum: Rep[Long] = column[Long]("SIASOPTRFNUM")
    ...
    /** Foreign key referencing Fcsopt (database name FK_FCSIA_FCSOPT) */
    lazy val fcsoptFk = foreignKey("FK_FCSIA_FCSOPT", siasoptrfnum, Fcsopt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)

    /** Uniqueness Index over (siasmtrfnum,siasoptrfnum,siaimtrfnum,siatxntype) (database name UNQ_FCSIA_SMT_SOPT) */
    val index1 = index("UNQ_FCSIA_SMT_SOPT", (siasmtrfnum, siasoptrfnum, siaimtrfnum, siatxntype), unique=true)
  }
   ...
   *  @param sipstartdate Database column SIPSTARTDATE SqlType(DATE)
   *  @param sipenddate Database column SIPENDDATE SqlType(DATE), Default(None)
   ...
   *  @param sipstatus Database column SIPSTATUS SqlType(BIGINT)
   *  @param sipexternalid Database column SIPEXTERNALID SqlType(VARCHAR), Length(16,true), Default(None)
   *  @param sipdeductionday Database column SIPDEDUCTIONDAY SqlType(INT), Default(None)
   *  @param sipsotrfnum Database column SIPSOTRFNUM SqlType(BIGINT), Default(None)
   *  @param sipfomtrfnum Database column SIPFOMTRFNUM SqlType(BIGINT), Default(None)
   *  @param sipsoptrfnum Database column SIPSOPTRFNUM SqlType(BIGINT)
   *  @param sipterminationdate Database column SIPTERMINATIONDATE SqlType(DATE), Default(None)
   *  @param sipregistrationdate Database column SIPREGISTRATIONDATE SqlType(DATE)
   *  @param siprtaregslno Database column SIPRTAREGSLNO SqlType(VARCHAR), Length(64,true), Default(None)
   *  @param siprtatxntype Database column SIPRTATXNTYPE SqlType(VARCHAR), Length(16,true), Default(None)
   *  @param sipbseref Database column SIPBSEREF SqlType(CHAR), Length(16,false), Default(None)
   *  @param sipmmtlrfnum Database column SIPMMTLRFNUM SqlType(BIGINT), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcsipRow(id: Long, sipstartdate: java.sql.Date, sipenddate: Option[java.sql.Date] = None, sipinstallmentamount: Double, sipfrequency: String, sipnoofinstallments: Int, sipstatus: Long, sipexternalid: Option[String] = None, sipdeductionday: Option[Int] = None, sipsotrfnum: Option[Long] = None, sipfomtrfnum: Option[Long] = None, sipsoptrfnum: Long, sipterminationdate: Option[java.sql.Date] = None, sipregistrationdate: java.sql.Date, siprtaregslno: Option[String] = None, siprtatxntype: Option[String] = None, sipbseref: Option[String] = None, sipmmtlrfnum: Option[Long] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcsipRowWrapper(id: Option[Long], sipstartdate: java.sql.Date, sipenddate: Option[java.sql.Date] = None, sipinstallmentamount: Double, sipfrequency: String, sipnoofinstallments: Int, sipstatus: Long, sipexternalid: Option[String] = None, sipdeductionday: Option[Int] = None, sipsotrfnum: Option[Long] = None, sipfomtrfnum: Option[Long] = None, sipsoptrfnum: Long, sipterminationdate: Option[java.sql.Date] = None, sipregistrationdate: java.sql.Date, siprtaregslno: Option[String] = None, siprtatxntype: Option[String] = None, sipbseref: Option[String] = None, sipmmtlrfnum: Option[Long] = None) {
    def get(userName: String): FcsipRow = {
      FcsipRow(this.id.getOrElse(0), this.sipstartdate, this.sipenddate, this.sipinstallmentamount, this.sipfrequency, this.sipnoofinstallments, this.sipstatus, this.sipexternalid, this.sipdeductionday, this.sipsotrfnum, this.sipfomtrfnum, this.sipsoptrfnum, this.sipterminationdate, this.sipregistrationdate, this.siprtaregslno, this.siprtatxntype, this.sipbseref, this.sipmmtlrfnum, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcsipRow objects using plain SQL queries */
  implicit def GetResultFcsipRow(implicit e0: GR[Long], e1: GR[java.sql.Date], e2: GR[Option[java.sql.Date]], e3: GR[Double], e4: GR[String], e5: GR[Int], e6: GR[Option[String]], e7: GR[Option[Int]], e8: GR[Option[Long]], e9: GR[Option[java.sql.Timestamp]], e10: GR[java.sql.Timestamp]): GR[FcsipRow] = GR{
    prs => import prs._
    FcsipRow.tupled((<<[Long], <<[java.sql.Date], <<?[java.sql.Date], <<[Double], <<[String], <<[Int], <<[Long], <<?[String], <<?[Int], <<?[Long], <<?[Long], <<[Long], <<?[java.sql.Date], <<[java.sql.Date], <<?[String], <<?[String], <<?[String], <<?[Long], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcsip(_tableTag: Tag) extends BaseTable[FcsipRow](_tableTag, "FCSIP") {
    def * = (id, sipstartdate, sipenddate, sipinstallmentamount, sipfrequency, sipnoofinstallments, sipstatus, sipexternalid, sipdeductionday, sipsotrfnum, sipfomtrfnum, sipsoptrfnum, sipterminationdate, sipregistrationdate, siprtaregslno, siprtatxntype, sipbseref, sipmmtlrfnum, createdate, modifydate, createdby, lastmodifiedby) <> (FcsipRow.tupled, FcsipRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(sipstartdate), sipenddate, Rep.Some(sipinstallmentamount), Rep.Some(sipfrequency), Rep.Some(sipnoofinstallments), Rep.Some(sipstatus), sipexternalid, sipdeductionday, sipsotrfnum, sipfomtrfnum, Rep.Some(sipsoptrfnum), sipterminationdate, Rep.Some(sipregistrationdate), siprtaregslno, siprtatxntype, sipbseref, sipmmtlrfnum, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcsipRow.tupled((_1.get, _2.get, _3, _4.get, _5.get, _6.get, _7.get, _8, _9, _10, _11, _12.get, _13, _14.get, _15, _16, _17, _18, _19, _20.get, _21.get, _22.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column SIPSTARTDATE SqlType(DATE) */
    val sipstartdate: Rep[java.sql.Date] = column[java.sql.Date]("SIPSTARTDATE")
    /** Database column SIPENDDATE SqlType(DATE), Default(None) */
    val sipenddate: Rep[Option[java.sql.Date]] = column[Option[java.sql.Date]]("SIPENDDATE", O.Default(None))
    ...
    /** Database column SIPSTATUS SqlType(BIGINT) */
    val sipstatus: Rep[Long] = column[Long]("SIPSTATUS")
    ...
    /** Database column SIPDEDUCTIONDAY SqlType(INT), Default(None) */
    val sipdeductionday: Rep[Option[Int]] = column[Option[Int]]("SIPDEDUCTIONDAY", O.Default(None))
    /** Database column SIPSOTRFNUM SqlType(BIGINT), Default(None) */
    val sipsotrfnum: Rep[Option[Long]] = column[Option[Long]]("SIPSOTRFNUM", O.Default(None))
    /** Database column SIPFOMTRFNUM SqlType(BIGINT), Default(None) */
    val sipfomtrfnum: Rep[Option[Long]] = column[Option[Long]]("SIPFOMTRFNUM", O.Default(None))
    /** Database column SIPSOPTRFNUM SqlType(BIGINT) */
    val sipsoptrfnum: Rep[Long] = column[Long]("SIPSOPTRFNUM")
    /** Database column SIPTERMINATIONDATE SqlType(DATE), Default(None) */
    val sipterminationdate: Rep[Option[java.sql.Date]] = column[Option[java.sql.Date]]("SIPTERMINATIONDATE", O.Default(None))
    /** Database column SIPREGISTRATIONDATE SqlType(DATE) */
    val sipregistrationdate: Rep[java.sql.Date] = column[java.sql.Date]("SIPREGISTRATIONDATE")
    /** Database column SIPRTAREGSLNO SqlType(VARCHAR), Length(64,true), Default(None) */
    val siprtaregslno: Rep[Option[String]] = column[Option[String]]("SIPRTAREGSLNO", O.Length(64,varying=true), O.Default(None))
    /** Database column SIPRTATXNTYPE SqlType(VARCHAR), Length(16,true), Default(None) */
    val siprtatxntype: Rep[Option[String]] = column[Option[String]]("SIPRTATXNTYPE", O.Length(16,varying=true), O.Default(None))
    /** Database column SIPBSEREF SqlType(CHAR), Length(16,false), Default(None) */
    val sipbseref: Rep[Option[String]] = column[Option[String]]("SIPBSEREF", O.Length(16,varying=false), O.Default(None))
    /** Database column SIPMMTLRFNUM SqlType(BIGINT), Default(None) */
    val sipmmtlrfnum: Rep[Option[Long]] = column[Option[Long]]("SIPMMTLRFNUM", O.Default(None))
    ...
    lazy val fcfomtFk = foreignKey("FK_FCSIP_FCFOMT", sipfomtrfnum, Fcfomt)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcmmtl (database name FK_FCSIP_FCMMTL) */
    lazy val fcmmtlFk = foreignKey("FK_FCSIP_FCMMTL", sipmmtlrfnum, Fcmmtl)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcsopt (database name FK_FCSIP_FCSOPT) */
    lazy val fcsoptFk = foreignKey("FK_FCSIP_FCSOPT", sipsoptrfnum, Fcsopt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcsot (database name FK_FCSIP_FCSOT) */
    lazy val fcsotFk = foreignKey("FK_FCSIP_FCSOT", sipsotrfnum, Fcsot)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcspsm (database name FK_FCSIP_FCSPSM) */
    lazy val fcspsmFk = foreignKey("FK_FCSIP_FCSPSM", sipstatus, Fcspsm)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fcsip */
  lazy val Fcsip = new TableQuery(tag => new Fcsip(tag))

  /** Entity class storing rows of table Fcsiph
   *  @param siphrfnum Database column SIPHRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param siphsiprfnum Database column SIPHSIPRFNUM SqlType(BIGINT)
   *  @param siphspsmfromstate Database column SIPHSPSMFROMSTATE SqlType(BIGINT)
   *  @param siphspsmtostate Database column SIPHSPSMTOSTATE SqlType(BIGINT)
   *  @param siphremark Database column SIPHREMARK SqlType(VARCHAR), Length(128,true), Default(None)
   *  @param siphstatechangedate Database column SIPHSTATECHANGEDATE SqlType(DATE)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcsiphRow(id: Long, siphsiprfnum: Long, siphspsmfromstate: Long, siphspsmtostate: Long, siphremark: Option[String] = None, siphstatechangedate: java.sql.Date, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcsiphRowWrapper(id: Option[Long], siphsiprfnum: Long, siphspsmfromstate: Long, siphspsmtostate: Long, siphremark: Option[String] = None, siphstatechangedate: java.sql.Date) {
    def get(userName: String): FcsiphRow = {
      FcsiphRow(this.id.getOrElse(0), this.siphsiprfnum, this.siphspsmfromstate, this.siphspsmtostate, this.siphremark, this.siphstatechangedate, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcsiphRow objects using plain SQL queries */
  implicit def GetResultFcsiphRow(implicit e0: GR[Long], e1: GR[Option[String]], e2: GR[java.sql.Date], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp], e5: GR[String]): GR[FcsiphRow] = GR{
    prs => import prs._
    FcsiphRow.tupled((<<[Long], <<[Long], <<[Long], <<[Long], <<?[String], <<[java.sql.Date], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCSIPH. Objects of this class serve as prototypes for rows in queries. */
  class Fcsiph(_tableTag: Tag) extends BaseTable[FcsiphRow](_tableTag, "FCSIPH") {
    def * = (id, siphsiprfnum, siphspsmfromstate, siphspsmtostate, siphremark, siphstatechangedate, createdate, modifydate, createdby, lastmodifiedby) <> (FcsiphRow.tupled, FcsiphRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(siphsiprfnum), Rep.Some(siphspsmfromstate), Rep.Some(siphspsmtostate), siphremark, Rep.Some(siphstatechangedate), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcsiphRow.tupled((_1.get, _2.get, _3.get, _4.get, _5, _6.get, _7, _8.get, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column SIPHRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("SIPHRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column SIPHSIPRFNUM SqlType(BIGINT) */
    val siphsiprfnum: Rep[Long] = column[Long]("SIPHSIPRFNUM")
    /** Database column SIPHSPSMFROMSTATE SqlType(BIGINT) */
    val siphspsmfromstate: Rep[Long] = column[Long]("SIPHSPSMFROMSTATE")
    /** Database column SIPHSPSMTOSTATE SqlType(BIGINT) */
    val siphspsmtostate: Rep[Long] = column[Long]("SIPHSPSMTOSTATE")
    /** Database column SIPHREMARK SqlType(VARCHAR), Length(128,true), Default(None) */
    val siphremark: Rep[Option[String]] = column[Option[String]]("SIPHREMARK", O.Length(128,varying=true), O.Default(None))
    /** Database column SIPHSTATECHANGEDATE SqlType(DATE) */
    val siphstatechangedate: Rep[java.sql.Date] = column[java.sql.Date]("SIPHSTATECHANGEDATE")





    /** Foreign key referencing Fcsip (database name FK_FCSIPH_FCSIP) */
    lazy val fcsipFk = foreignKey("FK_FCSIPH_FCSIP", siphsiprfnum, Fcsip)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcspsm (database name FK_FCSIPH_FCSPSM) */
    lazy val fcspsmFk2 = foreignKey("FK_FCSIPH_FCSPSM", siphspsmfromstate, Fcspsm)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcspsm (database name FK_FCSIPH_FCSPSM_02) */
    lazy val fcspsmFk3 = foreignKey("FK_FCSIPH_FCSPSM_02", siphspsmtostate, Fcspsm)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fcsiph */
  lazy val Fcsiph = new TableQuery(tag => new Fcsiph(tag))
   ...
   *  @param smtrtapurchasecutoff Database column SMTRTAPURCHASECUTOFF SqlType(TIME), Default(None)
   *  @param smtredemptioncutoff Database column SMTREDEMPTIONCUTOFF SqlType(TIME), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcsmtRow(id: Long, smtamctrfnum: Long, smtstdname: String, smtdisplayname: String, smtrtacoderfnum: Long, smtmstarid: Option[String] = None, smtisin: Option[String] = None, smtunitallotmentperiod: Option[Long] = None, smtfacevalue: Option[Double] = None, smtctmtrfnum: Long, smtfincashrisk: Option[String] = None, smtsebirisk: Option[String] = None, smtfunddescription: Option[String] = None, smtschemeactive: String, smtrtapurchasecutoff: Option[java.sql.Time] = None, smtredemptioncutoff: Option[java.sql.Time] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcsmtRowWrapper(id: Option[Long], smtamctrfnum: Long, smtstdname: String, smtdisplayname: String, smtrtacoderfnum: Long, smtmstarid: Option[String] = None, smtisin: Option[String] = None, smtunitallotmentperiod: Option[Long] = None, smtfacevalue: Option[Double] = None, smtctmtrfnum: Long, smtfincashrisk: Option[String] = None, smtsebirisk: Option[String] = None, smtfunddescription: Option[String] = None, smtschemeactive: String, smtrtapurchasecutoff: Option[java.sql.Time] = None, smtredemptioncutoff: Option[java.sql.Time] = None) {
    def get(userName: String): FcsmtRow = {
      FcsmtRow(this.id.getOrElse(0), this.smtamctrfnum, this.smtstdname, this.smtdisplayname, this.smtrtacoderfnum, this.smtmstarid, this.smtisin, this.smtunitallotmentperiod, this.smtfacevalue, this.smtctmtrfnum, this.smtfincashrisk, this.smtsebirisk, this.smtfunddescription, this.smtschemeactive, this.smtrtapurchasecutoff, this.smtredemptioncutoff, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcsmtRow objects using plain SQL queries */
  implicit def GetResultFcsmtRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[Long]], e4: GR[Option[Double]], e5: GR[Option[java.sql.Time]], e6: GR[Option[java.sql.Timestamp]], e7: GR[java.sql.Timestamp]): GR[FcsmtRow] = GR{
    prs => import prs._
    FcsmtRow.tupled((<<[Long], <<[Long], <<[String], <<[String], <<[Long], <<?[String], <<?[String], <<?[Long], <<?[Double], <<[Long], <<?[String], <<?[String], <<?[String], <<[String], <<?[java.sql.Time], <<?[java.sql.Time], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcsmt(_tableTag: Tag) extends BaseTable[FcsmtRow](_tableTag, "FCSMT") {
    def * = (id, smtamctrfnum, smtstdname, smtdisplayname, smtrtacoderfnum, smtmstarid, smtisin, smtunitallotmentperiod, smtfacevalue, smtctmtrfnum, smtfincashrisk, smtsebirisk, smtfunddescription, smtschemeactive, smtrtapurchasecutoff, smtredemptioncutoff, createdate, modifydate, createdby, lastmodifiedby) <> (FcsmtRow.tupled, FcsmtRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(smtamctrfnum), Rep.Some(smtstdname), Rep.Some(smtdisplayname), Rep.Some(smtrtacoderfnum), smtmstarid, smtisin, smtunitallotmentperiod, smtfacevalue, Rep.Some(smtctmtrfnum), smtfincashrisk, smtsebirisk, smtfunddescription, Rep.Some(smtschemeactive), smtrtapurchasecutoff, smtredemptioncutoff, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcsmtRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6, _7, _8, _9, _10.get, _11, _12, _13, _14.get, _15, _16, _17, _18.get, _19.get, _20.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column SMTRTAPURCHASECUTOFF SqlType(TIME), Default(None) */
    val smtrtapurchasecutoff: Rep[Option[java.sql.Time]] = column[Option[java.sql.Time]]("SMTRTAPURCHASECUTOFF", O.Default(None))
    /** Database column SMTREDEMPTIONCUTOFF SqlType(TIME), Default(None) */
    val smtredemptioncutoff: Rep[Option[java.sql.Time]] = column[Option[java.sql.Time]]("SMTREDEMPTIONCUTOFF", O.Default(None))
   ...
   *  @param soctvaluedate Database column SOCTVALUEDATE SqlType(TIMESTAMP), Default(None)
   *  @param soctvaluedouble Database column SOCTVALUEDOUBLE SqlType(DOUBLE), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcsoctRow(id: Long, soctkey: String, soctvalue: String, soctsotrfnum: Long, soctvaluedate: Option[java.sql.Timestamp] = None, soctvaluedouble: Option[Double] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcsoctRowWrapper(id: Option[Long], soctkey: String, soctvalue: String, soctsotrfnum: Long, soctvaluedate: Option[java.sql.Timestamp] = None, soctvaluedouble: Option[Double] = None) {
    def get(userName: String): FcsoctRow = {
      FcsoctRow(this.id.getOrElse(0), this.soctkey, this.soctvalue, this.soctsotrfnum, this.soctvaluedate, this.soctvaluedouble, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcsoctRow objects using plain SQL queries */
  implicit def GetResultFcsoctRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[java.sql.Timestamp]], e3: GR[Option[Double]], e4: GR[java.sql.Timestamp]): GR[FcsoctRow] = GR{
    prs => import prs._
    FcsoctRow.tupled((<<[Long], <<[String], <<[String], <<[Long], <<?[java.sql.Timestamp], <<?[Double], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcsoct(_tableTag: Tag) extends BaseTable[FcsoctRow](_tableTag, "FCSOCT") {
    def * = (id, soctkey, soctvalue, soctsotrfnum, soctvaluedate, soctvaluedouble, createdate, modifydate, createdby, lastmodifiedby) <> (FcsoctRow.tupled, FcsoctRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(soctkey), Rep.Some(soctvalue), Rep.Some(soctsotrfnum), soctvaluedate, soctvaluedouble, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcsoctRow.tupled((_1.get, _2.get, _3.get, _4.get, _5, _6, _7, _8.get, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column SOCTVALUEDATE SqlType(TIMESTAMP), Default(None) */
    val soctvaluedate: Rep[Option[java.sql.Timestamp]] = column[Option[java.sql.Timestamp]]("SOCTVALUEDATE", O.Default(None))
    /** Database column SOCTVALUEDOUBLE SqlType(DOUBLE), Default(None) */
    val soctvaluedouble: Rep[Option[Double]] = column[Option[Double]]("SOCTVALUEDOUBLE", O.Default(None))
  ...
  /** Entity class storing rows of table Fcspsm
   *  @param spsmrfnum Database column SPSMRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param spsmname Database column SPSMNAME SqlType(VARCHAR), Length(64,true)
   *  @param spsmactive Database column SPSMACTIVE SqlType(CHAR), Length(2,false)
   *  @param spsmdescription Database column SPSMDESCRIPTION SqlType(VARCHAR), Length(256,true), Default(None)
   *  @param spsmdisplayname Database column SPSMDISPLAYNAME SqlType(VARCHAR), Length(32,true)
   *  @param spsmtooltip Database column SPSMTOOLTIP SqlType(VARCHAR), Length(128,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcspsmRow(id: Long, spsmname: String, spsmactive: String, spsmdescription: Option[String] = None, spsmdisplayname: String, spsmtooltip: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcspsmRowWrapper(id: Option[Long], spsmname: String, spsmactive: String, spsmdescription: Option[String] = None, spsmdisplayname: String, spsmtooltip: Option[String] = None) {
    def get(userName: String): FcspsmRow = {
      FcspsmRow(this.id.getOrElse(0), this.spsmname, this.spsmactive, this.spsmdescription, this.spsmdisplayname, this.spsmtooltip, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcspsmRow objects using plain SQL queries */
  implicit def GetResultFcspsmRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[String]], e3: GR[Option[java.sql.Timestamp]], e4: GR[java.sql.Timestamp]): GR[FcspsmRow] = GR{
    prs => import prs._
    FcspsmRow.tupled((<<[Long], <<[String], <<[String], <<?[String], <<[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCSPSM. Objects of this class serve as prototypes for rows in queries. */
  class Fcspsm(_tableTag: Tag) extends BaseTable[FcspsmRow](_tableTag, "FCSPSM") {
    def * = (id, spsmname, spsmactive, spsmdescription, spsmdisplayname, spsmtooltip, createdate, modifydate, createdby, lastmodifiedby) <> (FcspsmRow.tupled, FcspsmRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(spsmname), Rep.Some(spsmactive), spsmdescription, Rep.Some(spsmdisplayname), spsmtooltip, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcspsmRow.tupled((_1.get, _2.get, _3.get, _4, _5.get, _6, _7, _8.get, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column SPSMRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("SPSMRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column SPSMNAME SqlType(VARCHAR), Length(64,true) */
    val spsmname: Rep[String] = column[String]("SPSMNAME", O.Length(64,varying=true))
    /** Database column SPSMACTIVE SqlType(CHAR), Length(2,false) */
    val spsmactive: Rep[String] = column[String]("SPSMACTIVE", O.Length(2,varying=false))
    /** Database column SPSMDESCRIPTION SqlType(VARCHAR), Length(256,true), Default(None) */
    val spsmdescription: Rep[Option[String]] = column[Option[String]]("SPSMDESCRIPTION", O.Length(256,varying=true), O.Default(None))
    /** Database column SPSMDISPLAYNAME SqlType(VARCHAR), Length(32,true) */
    val spsmdisplayname: Rep[String] = column[String]("SPSMDISPLAYNAME", O.Length(32,varying=true))
    /** Database column SPSMTOOLTIP SqlType(VARCHAR), Length(128,true), Default(None) */
    val spsmtooltip: Rep[Option[String]] = column[Option[String]]("SPSMTOOLTIP", O.Length(128,varying=true), O.Default(None))
  }
  /** Collection-like TableQuery object for table Fcspsm */
  lazy val Fcspsm = new TableQuery(tag => new Fcspsm(tag))
   ...
   *  @param sstamount Database column SSTAMOUNT SqlType(DOUBLE), Default(None)
   *  @param sstdate Database column SSTDATE SqlType(DATE), Default(None)
   *  @param sstcreditdebitflag Database column SSTCREDITDEBITFLAG SqlType(VARCHAR), Length(2,true), Default(None)
   *  @param sstfhsrfnum Database column SSTFHSRFNUM SqlType(BIGINT), Default(None)
   *  @param sstbsetrxnref Database column SSTBSETRXNREF SqlType(CHAR), Length(16,false), Default(None)
   *  @param sststatus Database column SSTSTATUS SqlType(CHAR), Length(10,false)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcsstRow(id: Long, sstsiprfnum: Long, sstamount: Option[Double] = None, sstdate: Option[java.sql.Date] = None, sstcreditdebitflag: Option[String] = None, sstfhsrfnum: Option[Long] = None, sstbsetrxnref: Option[String] = None, sststatus: String, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcsstRowWrapper(id: Option[Long], sstsiprfnum: Long, sstamount: Option[Double] = None, sstdate: Option[java.sql.Date] = None, sstcreditdebitflag: Option[String] = None, sstfhsrfnum: Option[Long] = None, sstbsetrxnref: Option[String] = None, sststatus: String) {
    def get(userName: String): FcsstRow = {
      FcsstRow(this.id.getOrElse(0), this.sstsiprfnum, this.sstamount, this.sstdate, this.sstcreditdebitflag, this.sstfhsrfnum, this.sstbsetrxnref, this.sststatus, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcsstRow objects using plain SQL queries */
  implicit def GetResultFcsstRow(implicit e0: GR[Long], e1: GR[Option[Double]], e2: GR[Option[java.sql.Date]], e3: GR[Option[String]], e4: GR[Option[Long]], e5: GR[String], e6: GR[Option[java.sql.Timestamp]], e7: GR[java.sql.Timestamp]): GR[FcsstRow] = GR{
    prs => import prs._
    FcsstRow.tupled((<<[Long], <<[Long], <<?[Double], <<?[java.sql.Date], <<?[String], <<?[Long], <<?[String], <<[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcsst(_tableTag: Tag) extends BaseTable[FcsstRow](_tableTag, "FCSST") {
    def * = (id, sstsiprfnum, sstamount, sstdate, sstcreditdebitflag, sstfhsrfnum, sstbsetrxnref, sststatus, createdate, modifydate, createdby, lastmodifiedby) <> (FcsstRow.tupled, FcsstRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(sstsiprfnum), sstamount, sstdate, sstcreditdebitflag, sstfhsrfnum, sstbsetrxnref, Rep.Some(sststatus), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcsstRow.tupled((_1.get, _2.get, _3, _4, _5, _6, _7, _8.get, _9, _10.get, _11.get, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column SSTAMOUNT SqlType(DOUBLE), Default(None) */
    val sstamount: Rep[Option[Double]] = column[Option[Double]]("SSTAMOUNT", O.Default(None))
    /** Database column SSTDATE SqlType(DATE), Default(None) */
    val sstdate: Rep[Option[java.sql.Date]] = column[Option[java.sql.Date]]("SSTDATE", O.Default(None))
    /** Database column SSTCREDITDEBITFLAG SqlType(VARCHAR), Length(2,true), Default(None) */
    val sstcreditdebitflag: Rep[Option[String]] = column[Option[String]]("SSTCREDITDEBITFLAG", O.Length(2,varying=true), O.Default(None))
    /** Database column SSTFHSRFNUM SqlType(BIGINT), Default(None) */
    val sstfhsrfnum: Rep[Option[Long]] = column[Option[Long]]("SSTFHSRFNUM", O.Default(None))
    /** Database column SSTBSETRXNREF SqlType(CHAR), Length(16,false), Default(None) */
    val sstbsetrxnref: Rep[Option[String]] = column[Option[String]]("SSTBSETRXNREF", O.Length(16,varying=false), O.Default(None))
    /** Database column SSTSTATUS SqlType(CHAR), Length(10,false) */
    val sststatus: Rep[String] = column[String]("SSTSTATUS", O.Length(10,varying=false))





    /** Foreign key referencing Fcfhs (database name FK_FCSST_FCFHS) */
    lazy val fcfhsFk = foreignKey("FK_FCSST_FCFHS", sstfhsrfnum, Fcfhs)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  ...
  /** Entity class storing rows of table Fctkt
   *  @param tktrfnum Database column TKTRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param tktticketid Database column TKTTICKETID SqlType(VARCHAR), Length(32,true)
   *  @param tktcndpurpose Database column TKTCNDPURPOSE SqlType(BIGINT), Default(None)
   *  @param tktubdrfnum Database column TKTUBDRFNUM SqlType(BIGINT), Default(None)
   *  @param tktsotrfnum Database column TKTSOTRFNUM SqlType(BIGINT), Default(None)
   *  @param tktremark Database column TKTREMARK SqlType(VARCHAR), Length(256,true), Default(None)
   *  @param tktstate Database column TKTSTATE SqlType(VARCHAR), Length(32,true), Default(None)
   *  @param tktsource Database column TKTSOURCE SqlType(VARCHAR), Length(32,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FctktRow(id: Long, tktticketid: String, tktcndpurpose: Option[Long] = None, tktubdrfnum: Option[Long] = None, tktsotrfnum: Option[Long] = None, tktremark: Option[String] = None, tktstate: Option[String] = None, tktsource: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FctktRowWrapper(id: Option[Long], tktticketid: String, tktcndpurpose: Option[Long] = None, tktubdrfnum: Option[Long] = None, tktsotrfnum: Option[Long] = None, tktremark: Option[String] = None, tktstate: Option[String] = None, tktsource: Option[String] = None) {
    def get(userName: String): FctktRow = {
      FctktRow(this.id.getOrElse(0), this.tktticketid, this.tktcndpurpose, this.tktubdrfnum, this.tktsotrfnum, this.tktremark, this.tktstate, this.tktsource, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FctktRow objects using plain SQL queries */
  implicit def GetResultFctktRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[Long]], e3: GR[Option[String]], e4: GR[Option[java.sql.Timestamp]], e5: GR[java.sql.Timestamp]): GR[FctktRow] = GR{
    prs => import prs._
    FctktRow.tupled((<<[Long], <<[String], <<?[Long], <<?[Long], <<?[Long], <<?[String], <<?[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCTKT. Objects of this class serve as prototypes for rows in queries. */
  class Fctkt(_tableTag: Tag) extends BaseTable[FctktRow](_tableTag, "FCTKT") {
    def * = (id, tktticketid, tktcndpurpose, tktubdrfnum, tktsotrfnum, tktremark, tktstate, tktsource, createdate, modifydate, createdby, lastmodifiedby) <> (FctktRow.tupled, FctktRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(tktticketid), tktcndpurpose, tktubdrfnum, tktsotrfnum, tktremark, tktstate, tktsource, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FctktRow.tupled((_1.get, _2.get, _3, _4, _5, _6, _7, _8, _9, _10.get, _11.get, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column TKTRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("TKTRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column TKTTICKETID SqlType(VARCHAR), Length(32,true) */
    val tktticketid: Rep[String] = column[String]("TKTTICKETID", O.Length(32,varying=true))
    /** Database column TKTCNDPURPOSE SqlType(BIGINT), Default(None) */
    val tktcndpurpose: Rep[Option[Long]] = column[Option[Long]]("TKTCNDPURPOSE", O.Default(None))
    /** Database column TKTUBDRFNUM SqlType(BIGINT), Default(None) */
    val tktubdrfnum: Rep[Option[Long]] = column[Option[Long]]("TKTUBDRFNUM", O.Default(None))
    /** Database column TKTSOTRFNUM SqlType(BIGINT), Default(None) */
    val tktsotrfnum: Rep[Option[Long]] = column[Option[Long]]("TKTSOTRFNUM", O.Default(None))
    /** Database column TKTREMARK SqlType(VARCHAR), Length(256,true), Default(None) */
    val tktremark: Rep[Option[String]] = column[Option[String]]("TKTREMARK", O.Length(256,varying=true), O.Default(None))
    /** Database column TKTSTATE SqlType(VARCHAR), Length(32,true), Default(None) */
    val tktstate: Rep[Option[String]] = column[Option[String]]("TKTSTATE", O.Length(32,varying=true), O.Default(None))
    /** Database column TKTSOURCE SqlType(VARCHAR), Length(32,true), Default(None) */
    val tktsource: Rep[Option[String]] = column[Option[String]]("TKTSOURCE", O.Length(32,varying=true), O.Default(None))





    /** Foreign key referencing Fccnd (database name FK_FCTKT_FCCND) */
    lazy val fccndFk = foreignKey("FK_FCTKT_FCCND", tktcndpurpose, Fccnd)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcsot (database name FK_FCTKT_FCSOT) */
    lazy val fcsotFk = foreignKey("FK_FCTKT_FCSOT", tktsotrfnum, Fcsot)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
    /** Foreign key referencing Fcubd (database name FK_FCTKT_FCUBD) */
    lazy val fcubdFk = foreignKey("FK_FCTKT_FCUBD", tktubdrfnum, Fcubd)(r => Rep.Some(r.id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fctkt */
  lazy val Fctkt = new TableQuery(tag => new Fctkt(tag))

  /** Entity class storing rows of table Fctkth
   *  @param tkthrfnum Database column TKTHRFNUM SqlType(BIGINT), AutoInc, PrimaryKey
   *  @param tkthfromstate Database column TKTHFROMSTATE SqlType(VARCHAR), Length(32,true), Default(None)
   *  @param tkthtostate Database column TKTHTOSTATE SqlType(VARCHAR), Length(32,true), Default(None)
   *  @param tkthremark Database column TKTHREMARK SqlType(VARCHAR), Length(256,true), Default(None)
   *  @param tkthcrmresponse Database column TKTHCRMRESPONSE SqlType(VARCHAR), Length(256,true), Default(None)
   *  @param tkthtktrfnum Database column TKTHTKTRFNUM SqlType(BIGINT)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FctkthRow(id: Long, tkthfromstate: Option[String] = None, tkthtostate: Option[String] = None, tkthremark: Option[String] = None, tkthcrmresponse: Option[String] = None, tkthtktrfnum: Long, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FctkthRowWrapper(id: Option[Long], tkthfromstate: Option[String] = None, tkthtostate: Option[String] = None, tkthremark: Option[String] = None, tkthcrmresponse: Option[String] = None, tkthtktrfnum: Long) {
    def get(userName: String): FctkthRow = {
      FctkthRow(this.id.getOrElse(0), this.tkthfromstate, this.tkthtostate, this.tkthremark, this.tkthcrmresponse, this.tkthtktrfnum, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FctkthRow objects using plain SQL queries */
  implicit def GetResultFctkthRow(implicit e0: GR[Long], e1: GR[Option[String]], e2: GR[Option[java.sql.Timestamp]], e3: GR[java.sql.Timestamp], e4: GR[String]): GR[FctkthRow] = GR{
    prs => import prs._
    FctkthRow.tupled((<<[Long], <<?[String], <<?[String], <<?[String], <<?[String], <<[Long], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  /** Table description of table FCTKTH. Objects of this class serve as prototypes for rows in queries. */
  class Fctkth(_tableTag: Tag) extends BaseTable[FctkthRow](_tableTag, "FCTKTH") {
    def * = (id, tkthfromstate, tkthtostate, tkthremark, tkthcrmresponse, tkthtktrfnum, createdate, modifydate, createdby, lastmodifiedby) <> (FctkthRow.tupled, FctkthRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), tkthfromstate, tkthtostate, tkthremark, tkthcrmresponse, Rep.Some(tkthtktrfnum), createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FctkthRow.tupled((_1.get, _2, _3, _4, _5, _6.get, _7, _8.get, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))

    /** Database column TKTHRFNUM SqlType(BIGINT), AutoInc, PrimaryKey */
    override val id: Rep[Long] = column[Long]("TKTHRFNUM", O.AutoInc, O.PrimaryKey)
    /** Database column TKTHFROMSTATE SqlType(VARCHAR), Length(32,true), Default(None) */
    val tkthfromstate: Rep[Option[String]] = column[Option[String]]("TKTHFROMSTATE", O.Length(32,varying=true), O.Default(None))
    /** Database column TKTHTOSTATE SqlType(VARCHAR), Length(32,true), Default(None) */
    val tkthtostate: Rep[Option[String]] = column[Option[String]]("TKTHTOSTATE", O.Length(32,varying=true), O.Default(None))
    /** Database column TKTHREMARK SqlType(VARCHAR), Length(256,true), Default(None) */
    val tkthremark: Rep[Option[String]] = column[Option[String]]("TKTHREMARK", O.Length(256,varying=true), O.Default(None))
    /** Database column TKTHCRMRESPONSE SqlType(VARCHAR), Length(256,true), Default(None) */
    val tkthcrmresponse: Rep[Option[String]] = column[Option[String]]("TKTHCRMRESPONSE", O.Length(256,varying=true), O.Default(None))
    /** Database column TKTHTKTRFNUM SqlType(BIGINT) */
    val tkthtktrfnum: Rep[Long] = column[Long]("TKTHTKTRFNUM")





    /** Foreign key referencing Fctkt (database name FK_FCTKTH_FCTKT) */
    lazy val fctktFk = foreignKey("FK_FCTKTH_FCTKT", tkthtktrfnum, Fctkt)(r => r.id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  /** Collection-like TableQuery object for table Fctkth */
  lazy val Fctkth = new TableQuery(tag => new Fctkth(tag))
   ...
   *  @param uactipaddress Database column UACTIPADDRESS SqlType(VARCHAR), Length(64,true), Default(None)
   *  @param createdate 
   *  @param modifydate 
   *  @param createdby 
   *  @param lastmodifiedby  */
  case class FcuactRow(id: Long, uactcode: String, uactexpirydate: Option[java.sql.Timestamp] = None, uactubdrfnum: Long, uactisused: String, uactipaddress: Option[String] = None, createdate: Option[java.sql.Timestamp] = None, modifydate: java.sql.Timestamp, createdby: String, lastmodifiedby: String) extends BaseEntity 
  class FcuactRowWrapper(id: Option[Long], uactcode: String, uactexpirydate: Option[java.sql.Timestamp] = None, uactubdrfnum: Long, uactisused: String, uactipaddress: Option[String] = None) {
    def get(userName: String): FcuactRow = {
      FcuactRow(this.id.getOrElse(0), this.uactcode, this.uactexpirydate, this.uactubdrfnum, this.uactisused, this.uactipaddress, Some(DateTimeUtils.getCurrentTimeStamp), DateTimeUtils.getCurrentTimeStamp, userName, userName)
  	}
  }
  /** GetResult implicit for fetching FcuactRow objects using plain SQL queries */
  implicit def GetResultFcuactRow(implicit e0: GR[Long], e1: GR[String], e2: GR[Option[java.sql.Timestamp]], e3: GR[Option[String]], e4: GR[java.sql.Timestamp]): GR[FcuactRow] = GR{
    prs => import prs._
    FcuactRow.tupled((<<[Long], <<[String], <<?[java.sql.Timestamp], <<[Long], <<[String], <<?[String], <<?[java.sql.Timestamp], <<[java.sql.Timestamp], <<[String], <<[String]))
  }
  ...
  class Fcuact(_tableTag: Tag) extends BaseTable[FcuactRow](_tableTag, "FCUACT") {
    def * = (id, uactcode, uactexpirydate, uactubdrfnum, uactisused, uactipaddress, createdate, modifydate, createdby, lastmodifiedby) <> (FcuactRow.tupled, FcuactRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(uactcode), uactexpirydate, Rep.Some(uactubdrfnum), Rep.Some(uactisused), uactipaddress, createdate, Rep.Some(modifydate), Rep.Some(createdby), Rep.Some(lastmodifiedby)).shaped.<>({r=>import r._; _1.map(_=> FcuactRow.tupled((_1.get, _2.get, _3, _4.get, _5.get, _6, _7, _8.get, _9.get, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column UACTIPADDRESS SqlType(VARCHAR), Length(64,true), Default(None) */
    val uactipaddress: Rep[Option[String]] = column[Option[String]]("UACTIPADDRESS", O.Length(64,varying=true), O.Default(None))
