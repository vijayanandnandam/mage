...
class BSEStarOrderEntryServiceImpl @Inject()(implicit ec: ExecutionContext, @Named("bseOrderTemplate") bseOrderWebService: WebServiceTemplate,
                                             ...
                                             bSEResponseLogRepository: BSEResponseLogRepository,passwordRepository: PasswordRepository,
                                             bSEUploadResponseHelper : BSEUploadResponseHelper, bSEOrderResponseHelper : BSEOrderResponseHelper) extends BSEStarService
  with IntegrationConstants{

  val log = LoggerFactory.getLogger(classOf[BSEStarOrderEntryServiceImpl])

  /**
    * Gets Password Response from BSE Web Service
    *
    * @param getBSEPassword
    * @param uniqueRefNo
    * @return
    */
  ...
  /**
    * Gets Order Entry Response from BSE Web Service
    *
    * @param fcOrderEntry
    * @param integrationId
    * @param userName
    * @return
    */
  def getOrderEntryParamResponse(fcOrderEntry: FCOrderEntryModel, integrationId:String, userName:String): Future[BSEOrderValidateWrapper] = {

    fcService.getBSEOrderEntryParam(fcOrderEntry).flatMap { bseOrderEntryParam =>

      passwordRepository.getBSEEncryptedPassword(BSE_ORDER_API_PASS_CODE).map(encryptedPasswordTuple =>{
        ...
        bSERequestLogRepository.saveOrderEntryRequest(orderEntryParam, integrationId, userName)
        bSEResponseLogRepository.saveOrderEntryResponse(orderEntryParamResponse, integrationId, userName)
  ...
  /**
    * Gets Sip Order Entry Response from BSE Web Service
    *
    * @param fcSipOrderEntry
    * @param userName
    * @return
    */
  ...
  /**
    * Gets Xsip Order Entry Response from BSE Web Service
    *
    * @param fcXsipOrderEntry
    * @param integrationId
    * @param userName
    * @return
    */
  def getXsipOrderEntryParamResponse(fcXsipOrderEntry: FCXsipOrderEntryModel,integrationId:String, userName:String): Future[BSEXsipOrderValidateWrapper] = {
    ...
    fcService.getBSEXsipOrderEntryParam(fcXsipOrderEntry).flatMap{bseXsipOrderEntryParam =>
      ...
      passwordRepository.getBSEEncryptedPassword(BSE_ORDER_API_PASS_CODE).map(encryptedPasswordTuple =>{
        ...
        bSERequestLogRepository.saveXSipOrderEntryRequest(xsipOrderEntryParam, integrationId, userName)
        bSEResponseLogRepository.saveXSipOrderEntryResponse(xsipOrderEntryParamResponse, integrationId, userName)
  ...
  /**
    * Gets Spread Order Entry Response from BSE Web Service
    *
    * @param fCSpreadOrderEntryModel
    * @param userName
    * @return
    */
  ...
  /**
    * Gets Switch Order Entry Response from BSE Web Service
    *
    * @param fcSwitchOrderEntryModel
    * @param userName
    * @return
    */
