...
*/
case class UserLoginObject(username: Option[String], userid: Option[Long], foliocount: Option[Long], firstname: Option[String], pan: Option[String], mob: Option[String], isVerified: Option[String] = None)
